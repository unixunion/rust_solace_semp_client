...
pub struct ClientUsernameApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> ClientUsernameApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ClientUsernameApiClient<C> {
        ClientUsernameApiClient {
            configuration: configuration,
        }
    }
}

pub trait ClientUsernameApi {
...
impl<C: hyper::client::Connect>ClientUsernameApi for ClientUsernameApiClient<C> {
    fn get_msg_vpn_client_usernames(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnClientUsernamesResponse, Error = Error<serde_json::Value>>> {
