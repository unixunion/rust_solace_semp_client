...
pub struct MsgVpnDmrBridgesResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnDmrBridge>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnDmrBridgeLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnDmrBridgesResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnDmrBridgesResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnDmrBridge>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnDmrBridge>) -> MsgVpnDmrBridgesResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnDmrBridge>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnDmrBridgeLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnDmrBridgeLinks>) -> MsgVpnDmrBridgesResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnDmrBridgeLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnDmrBridgesResponse {
    self.meta = meta;
    self
  }
