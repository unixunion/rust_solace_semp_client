...
pub struct MsgVpnTopicEndpoint {
  ...
  /// The maximum number of consumer flows that can bind to the Topic Endpoint. The default value is `1`.
  ...
  /// The maximum message spool usage allowed by the Topic Endpoint, in megabytes (MB). A value of 0 only allows spooling of the last message received and disables quota checking. The default value is `4000`.
...
impl MsgVpnTopicEndpoint {
  ...
  pub fn with_delivery_count_enabled(mut self, delivery_count_enabled: bool) -> MsgVpnTopicEndpoint {
    self.delivery_count_enabled = Some(delivery_count_enabled);
    self
  }
  ...
  pub fn with_redelivery_enabled(mut self, redelivery_enabled: bool) -> MsgVpnTopicEndpoint {
    self.redelivery_enabled = Some(redelivery_enabled);
    self
  }
