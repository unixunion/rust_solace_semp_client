...
pub struct MsgVpnAuthorizationGroupLinks {
  /// The URI of this MsgVpnAuthorizationGroup object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnAuthorizationGroupLinks {
  pub fn new() -> MsgVpnAuthorizationGroupLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnAuthorizationGroupLinks {
    self.uri = Some(uri);
    self
  }
