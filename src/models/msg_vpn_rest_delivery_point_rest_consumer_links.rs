...
pub struct MsgVpnRestDeliveryPointRestConsumerLinks {
  /// The URI of this MsgVpnRestDeliveryPointRestConsumer's tlsTrustedCommonNames collection. Available since 2.2.0.
...
impl MsgVpnRestDeliveryPointRestConsumerLinks {
  pub fn new() -> MsgVpnRestDeliveryPointRestConsumerLinks {
  ...
  pub fn with_tls_trusted_common_names_uri(mut self, tls_trusted_common_names_uri: String) -> MsgVpnRestDeliveryPointRestConsumerLinks {
    self.tls_trusted_common_names_uri = Some(tls_trusted_common_names_uri);
    self
  }
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnRestDeliveryPointRestConsumerLinks {
    self.uri = Some(uri);
    self
  }
