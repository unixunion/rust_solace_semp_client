...
pub struct AuthorizationGroupApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> AuthorizationGroupApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> AuthorizationGroupApiClient<C> {
        AuthorizationGroupApiClient {
            configuration: configuration,
        }
    }
}

pub trait AuthorizationGroupApi {
...
impl<C: hyper::client::Connect>AuthorizationGroupApi for AuthorizationGroupApiClient<C> {
    fn create_msg_vpn_authorization_group(&self, msg_vpn_name: &str, body: ::models::MsgVpnAuthorizationGroup, opaque_password: &str, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnAuthorizationGroupResponse, Error = Error<serde_json::Value>>> {
