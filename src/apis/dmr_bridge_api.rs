...
pub struct DmrBridgeApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> DmrBridgeApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> DmrBridgeApiClient<C> {
        DmrBridgeApiClient {
...
impl<C: hyper::client::Connect>DmrBridgeApi for DmrBridgeApiClient<C> {
    fn create_msg_vpn_dmr_bridge(&self, msg_vpn_name: &str, body: ::models::MsgVpnDmrBridge, opaque_password: &str, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDmrBridgeResponse, Error = Error<serde_json::Value>>> {
