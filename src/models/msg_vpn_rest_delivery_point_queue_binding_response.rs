...
pub struct MsgVpnRestDeliveryPointQueueBindingResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnRestDeliveryPointQueueBinding>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnRestDeliveryPointQueueBindingLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnRestDeliveryPointQueueBindingResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnRestDeliveryPointQueueBindingResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnRestDeliveryPointQueueBinding) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnRestDeliveryPointQueueBinding) -> MsgVpnRestDeliveryPointQueueBindingResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnRestDeliveryPointQueueBinding> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnRestDeliveryPointQueueBindingLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnRestDeliveryPointQueueBindingLinks) -> MsgVpnRestDeliveryPointQueueBindingResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnRestDeliveryPointQueueBindingLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnRestDeliveryPointQueueBindingResponse {
    self.meta = meta;
    self
  }
