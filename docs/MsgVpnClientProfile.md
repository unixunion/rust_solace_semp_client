...
**reject_msg_to_sender_on_no_subscription_match_enabled** | **bool** | Enable or disable sending of a negative acknowledgement (NACK) on the discard of a message because of a message subscription was not found. The default value is &#x60;false&#x60;. | [optional] [default to null]
