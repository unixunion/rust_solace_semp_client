...
pub struct MsgVpnBridge {
  ...
  #[serde(rename = "remoteAuthenticationClientCertContent")]
  ...
  #[serde(rename = "remoteAuthenticationClientCertPassword")]
  ...
  /// The list of cipher suites supported for TLS connections to the Remote Message VPN. The default value is `\"ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-SHA384:ECDHE-RSA-AES256-SHA:AES256-GCM-SHA384:AES256-SHA256:AES256-SHA:ECDHE-RSA-DES-CBC3-SHA:DES-CBC3-SHA:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES128-SHA:AES128-GCM-SHA256:AES128-SHA256:AES128-SHA\"`.
