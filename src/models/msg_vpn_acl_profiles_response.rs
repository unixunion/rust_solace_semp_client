...
pub struct MsgVpnAclProfilesResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpnAclProfile>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnAclProfileLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnAclProfilesResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnAclProfilesResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnAclProfile>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnAclProfile>) -> MsgVpnAclProfilesResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnAclProfile>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnAclProfileLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnAclProfileLinks>) -> MsgVpnAclProfilesResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnAclProfileLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnAclProfilesResponse {
    self.meta = meta;
    self
  }
