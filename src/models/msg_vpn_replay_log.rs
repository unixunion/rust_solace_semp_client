...
impl MsgVpnReplayLog {
  pub fn new() -> MsgVpnReplayLog {
    MsgVpnReplayLog {
      egress_enabled: None,
  ...
  pub fn with_egress_enabled(mut self, egress_enabled: bool) -> MsgVpnReplayLog {
    self.egress_enabled = Some(egress_enabled);
    self
  }
  ...
  pub fn with_ingress_enabled(mut self, ingress_enabled: bool) -> MsgVpnReplayLog {
    self.ingress_enabled = Some(ingress_enabled);
    self
  }
  ...
  pub fn with_max_spool_usage(mut self, max_spool_usage: i64) -> MsgVpnReplayLog {
    self.max_spool_usage = Some(max_spool_usage);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnReplayLog {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_replay_log_name(mut self, replay_log_name: String) -> MsgVpnReplayLog {
    self.replay_log_name = Some(replay_log_name);
    self
  }
