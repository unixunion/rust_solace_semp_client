...
pub struct SystemInformationLinks {
  /// The URI of this SystemInformation object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl SystemInformationLinks {
  pub fn new() -> SystemInformationLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> SystemInformationLinks {
    self.uri = Some(uri);
    self
  }
