...
pub struct MsgVpnJndiTopicsResponse {
      #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnJndiTopic>>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnJndiTopicLinks>>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnJndiTopicsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnJndiTopicsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnJndiTopic>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnJndiTopic>) -> MsgVpnJndiTopicsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnJndiTopic>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnJndiTopicLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnJndiTopicLinks>) -> MsgVpnJndiTopicsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnJndiTopicLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnJndiTopicsResponse {
    self.meta = meta;
    self
  }
