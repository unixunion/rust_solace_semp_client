...
pub struct MsgVpnSequencedTopicsResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnSequencedTopic>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnSequencedTopicLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnSequencedTopicsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnSequencedTopicsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnSequencedTopic>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnSequencedTopic>) -> MsgVpnSequencedTopicsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnSequencedTopic>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnSequencedTopicLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnSequencedTopicLinks>) -> MsgVpnSequencedTopicsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnSequencedTopicLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnSequencedTopicsResponse {
    self.meta = meta;
    self
  }
