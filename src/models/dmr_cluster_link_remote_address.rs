...
pub struct DmrClusterLinkRemoteAddress {
  /// The name of the Cluster.
  #[serde(rename = "dmrClusterName", skip_serializing_if="Option::is_none")]
  dmr_cluster_name: Option<String>,
  /// The FQDN or IP address (and optional port) of the remote node. If port is not provided, it will vary based on the transport encoding: 55555 (plain-text), 55443 (encrypted), or 55003 (compressed).
...
impl DmrClusterLinkRemoteAddress {
  pub fn new() -> DmrClusterLinkRemoteAddress {
  ...
  pub fn with_dmr_cluster_name(mut self, dmr_cluster_name: String) -> DmrClusterLinkRemoteAddress {
    self.dmr_cluster_name = Some(dmr_cluster_name);
    self
  }
  ...
  pub fn with_remote_address(mut self, remote_address: String) -> DmrClusterLinkRemoteAddress {
    self.remote_address = Some(remote_address);
    self
  }
  ...
  pub fn with_remote_node_name(mut self, remote_node_name: String) -> DmrClusterLinkRemoteAddress {
    self.remote_node_name = Some(remote_node_name);
    self
  }
