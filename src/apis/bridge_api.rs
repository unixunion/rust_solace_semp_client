...
pub struct BridgeApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> BridgeApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> BridgeApiClient<C> {
        BridgeApiClient {
...
impl<C: hyper::client::Connect>BridgeApi for BridgeApiClient<C> {
    fn get_msg_vpn_bridges(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnBridgesResponse, Error = Error<serde_json::Value>>> {
