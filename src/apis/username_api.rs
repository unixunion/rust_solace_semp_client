...
pub struct UsernameApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> UsernameApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> UsernameApiClient<C> {
        UsernameApiClient {
...
pub trait UsernameApi {
    fn get_usernames(&self, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::UsernamesResponse, Error = Error<serde_json::Value>>>;
}


impl<C: hyper::client::Connect>UsernameApi for UsernameApiClient<C> {
    fn get_usernames(&self, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::UsernamesResponse, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::UsernamesResponse, _> = serde_json::from_slice(&body);
