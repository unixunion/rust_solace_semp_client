...
pub struct MsgVpnAclProfileSubscribeExceptionsResponse {
      #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnAclProfileSubscribeException>>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnAclProfileSubscribeExceptionLinks>>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnAclProfileSubscribeExceptionsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnAclProfileSubscribeExceptionsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnAclProfileSubscribeException>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnAclProfileSubscribeException>) -> MsgVpnAclProfileSubscribeExceptionsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnAclProfileSubscribeException>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnAclProfileSubscribeExceptionLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnAclProfileSubscribeExceptionLinks>) -> MsgVpnAclProfileSubscribeExceptionsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnAclProfileSubscribeExceptionLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnAclProfileSubscribeExceptionsResponse {
    self.meta = meta;
    self
  }
