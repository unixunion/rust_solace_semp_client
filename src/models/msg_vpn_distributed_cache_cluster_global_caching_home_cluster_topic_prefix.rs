...
pub struct MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
  ...
  #[serde(rename = "topicPrefix", skip_serializing_if="Option::is_none")]
  topic_prefix: Option<String>
}

impl MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
  pub fn new() -> MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
  ...
  pub fn with_cache_name(mut self, cache_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
    self.cache_name = Some(cache_name);
    self
  }
  ...
  pub fn with_cluster_name(mut self, cluster_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
    self.cluster_name = Some(cluster_name);
    self
  }
  ...
  pub fn with_home_cluster_name(mut self, home_cluster_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
    self.home_cluster_name = Some(home_cluster_name);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_topic_prefix(&mut self, topic_prefix: String) {
    self.topic_prefix = Some(topic_prefix);
  }

  pub fn with_topic_prefix(mut self, topic_prefix: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix {
    self.topic_prefix = Some(topic_prefix);
    self
  }

  pub fn topic_prefix(&self) -> Option<&String> {
    self.topic_prefix.as_ref()
  }

  pub fn reset_topic_prefix(&mut self) {
