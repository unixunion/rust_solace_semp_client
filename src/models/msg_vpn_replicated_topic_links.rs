...
pub struct MsgVpnReplicatedTopicLinks {
  /// The URI of this MsgVpnReplicatedTopic object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnReplicatedTopicLinks {
  pub fn new() -> MsgVpnReplicatedTopicLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnReplicatedTopicLinks {
    self.uri = Some(uri);
    self
  }
