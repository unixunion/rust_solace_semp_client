...
pub struct MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName>) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks>) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNamesResponse {
    self.meta = meta;
    self
  }
