...
impl MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName {
  pub fn new() -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName {
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_rest_consumer_name(mut self, rest_consumer_name: String) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName {
    self.rest_consumer_name = Some(rest_consumer_name);
    self
  }
  ...
  pub fn with_rest_delivery_point_name(mut self, rest_delivery_point_name: String) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName {
    self.rest_delivery_point_name = Some(rest_delivery_point_name);
    self
  }
  ...
  pub fn with_tls_trusted_common_name(mut self, tls_trusted_common_name: String) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName {
    self.tls_trusted_common_name = Some(tls_trusted_common_name);
    self
  }
