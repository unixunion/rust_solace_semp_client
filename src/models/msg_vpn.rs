...
pub struct MsgVpn {
  ...
  /// The maximum number of Publisher (egress) flows that can be created in the Message VPN. The default value is `16000`.
  ...
  /// The maximum number of Subscriber (ingress) flows that can be created in the Message VPN. The default value is `16000`.
  ...
  /// Enable or disable \"legacy-show-clear\" SEMP over Message Bus for the current Message VPN. This applies only to SEMPv1. The default value is `false`.
  #[serde(rename = "sempOverMsgBusLegacyShowClearEnabled")]
