...
pub struct MsgVpnClientProfileLinks {
  /// The URI of this MsgVpnClientProfile object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnClientProfileLinks {
  pub fn new() -> MsgVpnClientProfileLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnClientProfileLinks {
    self.uri = Some(uri);
    self
  }
