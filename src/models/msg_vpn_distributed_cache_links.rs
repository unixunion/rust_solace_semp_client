...
pub struct MsgVpnDistributedCacheLinks {
  /// The URI of this MsgVpnDistributedCache's clusters collection.
  #[serde(rename = "clustersUri", skip_serializing_if="Option::is_none")]
  clusters_uri: Option<String>,
  /// The URI of this MsgVpnDistributedCache object.
  #[serde(rename = "uri", skip_serializing_if="Option::is_none")]
  uri: Option<String>
}

impl MsgVpnDistributedCacheLinks {
  pub fn new() -> MsgVpnDistributedCacheLinks {
  ...
  pub fn set_clusters_uri(&mut self, clusters_uri: String) {
    self.clusters_uri = Some(clusters_uri);
  }

  pub fn with_clusters_uri(mut self, clusters_uri: String) -> MsgVpnDistributedCacheLinks {
    self.clusters_uri = Some(clusters_uri);
    self
  }

  pub fn clusters_uri(&self) -> Option<&String> {
    self.clusters_uri.as_ref()
  }

  pub fn reset_clusters_uri(&mut self) {
    self.clusters_uri = None;
  }
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnDistributedCacheLinks {
    self.uri = Some(uri);
    self
  }
