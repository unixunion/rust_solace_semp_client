...
pub struct MsgVpnJndiConnectionFactory {
  ...
  /// The amount of time before making another attempt to connect or reconnect to the Router after it has been lost, in milliseconds. The default value is `3000`.
