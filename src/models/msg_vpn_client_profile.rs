...
pub struct MsgVpnClientProfile {
  ...
  #[serde(rename = "allowGuaranteedEndpointCreateDurability", skip_serializing_if="Option::is_none")]
  allow_guaranteed_endpoint_create_durability: Option<String>,
  ...
  #[serde(rename = "apiQueueManagementCopyFromOnCreateTemplateName", skip_serializing_if="Option::is_none")]
  api_queue_management_copy_from_on_create_template_name: Option<String>,
  ...
  #[serde(rename = "apiTopicEndpointManagementCopyFromOnCreateTemplateName", skip_serializing_if="Option::is_none")]
  api_topic_endpoint_management_copy_from_on_create_template_name: Option<String>,
  ...
  #[serde(rename = "serviceMinKeepaliveTimeout", skip_serializing_if="Option::is_none")]
  service_min_keepalive_timeout: Option<i32>,
  ...
  #[serde(rename = "serviceSmfMinKeepaliveEnabled", skip_serializing_if="Option::is_none")]
  service_smf_min_keepalive_enabled: Option<bool>,
...
impl MsgVpnClientProfile {
  pub fn new() -> MsgVpnClientProfile {
    MsgVpnClientProfile {
      ...
      allow_guaranteed_endpoint_create_durability: None,
      ...
      api_queue_management_copy_from_on_create_template_name: None,
      api_topic_endpoint_management_copy_from_on_create_name: None,
      api_topic_endpoint_management_copy_from_on_create_template_name: None,
      ...
      service_min_keepalive_timeout: None,
      service_smf_max_connection_count_per_client_username: None,
      service_smf_min_keepalive_enabled: None,
  ...
  pub fn set_allow_guaranteed_endpoint_create_durability(&mut self, allow_guaranteed_endpoint_create_durability: String) {
    self.allow_guaranteed_endpoint_create_durability = Some(allow_guaranteed_endpoint_create_durability);
  }

  pub fn with_allow_guaranteed_endpoint_create_durability(mut self, allow_guaranteed_endpoint_create_durability: String) -> MsgVpnClientProfile {
    self.allow_guaranteed_endpoint_create_durability = Some(allow_guaranteed_endpoint_create_durability);
    self
  }

  pub fn allow_guaranteed_endpoint_create_durability(&self) -> Option<&String> {
    self.allow_guaranteed_endpoint_create_durability.as_ref()
  }

  pub fn reset_allow_guaranteed_endpoint_create_durability(&mut self) {
    self.allow_guaranteed_endpoint_create_durability = None;
  }
  ...
  pub fn set_api_queue_management_copy_from_on_create_template_name(&mut self, api_queue_management_copy_from_on_create_template_name: String) {
    self.api_queue_management_copy_from_on_create_template_name = Some(api_queue_management_copy_from_on_create_template_name);
  }

  pub fn with_api_queue_management_copy_from_on_create_template_name(mut self, api_queue_management_copy_from_on_create_template_name: String) -> MsgVpnClientProfile {
    self.api_queue_management_copy_from_on_create_template_name = Some(api_queue_management_copy_from_on_create_template_name);
    self
  }

  pub fn api_queue_management_copy_from_on_create_template_name(&self) -> Option<&String> {
    self.api_queue_management_copy_from_on_create_template_name.as_ref()
  }

  pub fn reset_api_queue_management_copy_from_on_create_template_name(&mut self) {
    self.api_queue_management_copy_from_on_create_template_name = None;
  }
  ...
  pub fn set_api_topic_endpoint_management_copy_from_on_create_template_name(&mut self, api_topic_endpoint_management_copy_from_on_create_template_name: String) {
    self.api_topic_endpoint_management_copy_from_on_create_template_name = Some(api_topic_endpoint_management_copy_from_on_create_template_name);
  }

  pub fn with_api_topic_endpoint_management_copy_from_on_create_template_name(mut self, api_topic_endpoint_management_copy_from_on_create_template_name: String) -> MsgVpnClientProfile {
    self.api_topic_endpoint_management_copy_from_on_create_template_name = Some(api_topic_endpoint_management_copy_from_on_create_template_name);
    self
  }

  pub fn api_topic_endpoint_management_copy_from_on_create_template_name(&self) -> Option<&String> {
    self.api_topic_endpoint_management_copy_from_on_create_template_name.as_ref()
  }

  pub fn reset_api_topic_endpoint_management_copy_from_on_create_template_name(&mut self) {
    self.api_topic_endpoint_management_copy_from_on_create_template_name = None;
  }
  ...
  pub fn set_service_min_keepalive_timeout(&mut self, service_min_keepalive_timeout: i32) {
    self.service_min_keepalive_timeout = Some(service_min_keepalive_timeout);
  }

  pub fn with_service_min_keepalive_timeout(mut self, service_min_keepalive_timeout: i32) -> MsgVpnClientProfile {
    self.service_min_keepalive_timeout = Some(service_min_keepalive_timeout);
    self
  }

  pub fn service_min_keepalive_timeout(&self) -> Option<&i32> {
    self.service_min_keepalive_timeout.as_ref()
  }

  pub fn reset_service_min_keepalive_timeout(&mut self) {
    self.service_min_keepalive_timeout = None;
  }
  ...
  pub fn set_service_smf_min_keepalive_enabled(&mut self, service_smf_min_keepalive_enabled: bool) {
    self.service_smf_min_keepalive_enabled = Some(service_smf_min_keepalive_enabled);
  }

  pub fn with_service_smf_min_keepalive_enabled(mut self, service_smf_min_keepalive_enabled: bool) -> MsgVpnClientProfile {
    self.service_smf_min_keepalive_enabled = Some(service_smf_min_keepalive_enabled);
    self
  }

  pub fn service_smf_min_keepalive_enabled(&self) -> Option<&bool> {
    self.service_smf_min_keepalive_enabled.as_ref()
  }

  pub fn reset_service_smf_min_keepalive_enabled(&mut self) {
    self.service_smf_min_keepalive_enabled = None;
  }
