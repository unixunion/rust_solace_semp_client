...
pub struct MsgVpnLinks {
  ...
  /// The URI of this MsgVpn's jndiConnectionFactories collection. Available since 2.2.0.
  #[serde(rename = "jndiConnectionFactoriesUri")]
  jndi_connection_factories_uri: Option<String>,
  /// The URI of this MsgVpn's jndiQueues collection. Available since 2.2.0.
  #[serde(rename = "jndiQueuesUri")]
  jndi_queues_uri: Option<String>,
  /// The URI of this MsgVpn's jndiTopics collection. Available since 2.2.0.
  #[serde(rename = "jndiTopicsUri")]
  jndi_topics_uri: Option<String>,
  /// The URI of this MsgVpn's mqttSessions collection. Available since 2.1.0.
  ...
  /// The URI of this MsgVpn's replicatedTopics collection. Available since 2.1.0.
  ...
  /// The URI of this MsgVpn's topicEndpoints collection. Available since 2.1.0.
