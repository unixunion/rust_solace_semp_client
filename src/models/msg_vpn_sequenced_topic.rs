...
pub struct MsgVpnSequencedTopic {
  ...
  #[serde(rename = "sequencedTopic")]
  sequenced_topic: Option<String>
}

impl MsgVpnSequencedTopic {
  pub fn new() -> MsgVpnSequencedTopic {
    MsgVpnSequencedTopic {
      msg_vpn_name: None,
      sequenced_topic: None
    }
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnSequencedTopic {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_sequenced_topic(&mut self, sequenced_topic: String) {
    self.sequenced_topic = Some(sequenced_topic);
  }

  pub fn with_sequenced_topic(mut self, sequenced_topic: String) -> MsgVpnSequencedTopic {
    self.sequenced_topic = Some(sequenced_topic);
    self
  }

  pub fn sequenced_topic(&self) -> Option<&String> {
    self.sequenced_topic.as_ref()
  }

  pub fn reset_sequenced_topic(&mut self) {
    self.sequenced_topic = None;
  }
