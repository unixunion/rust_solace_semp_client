...
impl MsgVpnAclProfileClientConnectException {
  pub fn new() -> MsgVpnAclProfileClientConnectException {
    MsgVpnAclProfileClientConnectException {
      acl_profile_name: None,
      client_connect_exception_address: None,
      msg_vpn_name: None
    }
  }
  ...
  pub fn with_acl_profile_name(mut self, acl_profile_name: String) -> MsgVpnAclProfileClientConnectException {
    self.acl_profile_name = Some(acl_profile_name);
    self
  }
  ...
  pub fn set_client_connect_exception_address(&mut self, client_connect_exception_address: String) {
    self.client_connect_exception_address = Some(client_connect_exception_address);
  }

  pub fn with_client_connect_exception_address(mut self, client_connect_exception_address: String) -> MsgVpnAclProfileClientConnectException {
    self.client_connect_exception_address = Some(client_connect_exception_address);
    self
  }

  pub fn client_connect_exception_address(&self) -> Option<&String> {
    self.client_connect_exception_address.as_ref()
  }

  pub fn reset_client_connect_exception_address(&mut self) {
    self.client_connect_exception_address = None;
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnAclProfileClientConnectException {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
