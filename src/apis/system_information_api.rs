...
pub trait SystemInformationApi {
    fn get_system_information(&self, ) -> Box<Future<Item = ::models::SystemInformationResponse, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>SystemInformationApi for SystemInformationApiClient<C> {
    fn get_system_information(&self, ) -> Box<Future<Item = ::models::SystemInformationResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/systemInformation?{}", configuration.base_path, query_string);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<::models::SystemInformationResponse, _> = serde_json::from_slice(&body);
