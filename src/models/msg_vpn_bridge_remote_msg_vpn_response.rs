...
pub struct MsgVpnBridgeRemoteMsgVpnResponse {
      #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnBridgeRemoteMsgVpn>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnBridgeRemoteMsgVpnLinks>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnBridgeRemoteMsgVpnResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnBridgeRemoteMsgVpnResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnBridgeRemoteMsgVpn) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnBridgeRemoteMsgVpn) -> MsgVpnBridgeRemoteMsgVpnResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnBridgeRemoteMsgVpn> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnBridgeRemoteMsgVpnLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnBridgeRemoteMsgVpnLinks) -> MsgVpnBridgeRemoteMsgVpnResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnBridgeRemoteMsgVpnLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnBridgeRemoteMsgVpnResponse {
    self.meta = meta;
    self
  }
