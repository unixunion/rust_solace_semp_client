...
pub struct MsgVpnTopicEndpoint {
  /// The Topic Endpoint access type of either \"exclusive\" or \"non-exclusive\". The default value is `\"exclusive\"`. The allowed values and their meaning are:  <pre> \"exclusive\" - Exclusive delivery of messages to first bound client. \"non-exclusive\" - Non-exclusive delivery of messages to all bound clients. </pre>  Available since 2.4.0.
  ...
  /// Identifies the name of the queue which should be used as the Topic Endpoint's dead message queue. The default value is \"#DEAD_MSG_QUEUE\". The default value is `\"#DEAD_MSG_QUEUE\"`.
  #[serde(rename = "deadMsgQueue")]
  dead_msg_queue: Option<String>,
  /// Enable or disable the outgoing (egress) flow of messages from the Topic Endpoint. The default value is false. The default value is `false`.
  ...
  /// Enable or disable the incoming (ingress) flow of messages to the Topic Endpoint. The default value is `false`.
  #[serde(rename = "ingressEnabled")]
  ingress_enabled: Option<bool>,
  /// The maximum number of simultaneous Consumers of the Topic Endpoint. The default value is `1`. Available since 2.4.0.
