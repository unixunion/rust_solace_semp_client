...
pub struct MsgVpnRestDeliveryPointRestConsumer {
  ...
  /// The password for the username. The default value is `\"\"`.
  ...
  /// The colon-separated list of cipher-suites the REST Consumer uses in its encrypted connection. All supported suites are included by default, from most-secure to least-secure. The REST Consumer should choose the first suite from this list that it supports. The default value is `\"default\"`.
  #[serde(rename = "tlsCipherSuiteList", skip_serializing_if="Option::is_none")]
  tls_cipher_suite_list: Option<String>,
  /// Indicates whether TLS for the REST Consumer is enabled. The default value is `false`.
