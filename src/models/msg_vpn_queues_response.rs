...
pub struct MsgVpnQueuesResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpnQueue>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnQueueLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnQueuesResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnQueuesResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnQueue>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnQueue>) -> MsgVpnQueuesResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnQueue>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnQueueLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnQueueLinks>) -> MsgVpnQueuesResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnQueueLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnQueuesResponse {
    self.meta = meta;
    self
  }
