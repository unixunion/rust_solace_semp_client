...
impl EventThresholdByPercent {
  pub fn new() -> EventThresholdByPercent {
  ...
  pub fn set_clear_percent(&mut self, clear_percent: i64) {
    self.clear_percent = Some(clear_percent);
  }

  pub fn with_clear_percent(mut self, clear_percent: i64) -> EventThresholdByPercent {
    self.clear_percent = Some(clear_percent);
    self
  }

  pub fn clear_percent(&self) -> Option<&i64> {
    self.clear_percent.as_ref()
  }

  pub fn reset_clear_percent(&mut self) {
  ...
  pub fn with_set_percent(mut self, set_percent: i64) -> EventThresholdByPercent {
    self.set_percent = Some(set_percent);
    self
  }

  pub fn set_percent(&self) -> Option<&i64> {
    self.set_percent.as_ref()
  }

  pub fn reset_set_percent(&mut self) {
