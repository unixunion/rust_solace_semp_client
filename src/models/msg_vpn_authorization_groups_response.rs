...
pub struct MsgVpnAuthorizationGroupsResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnAuthorizationGroup>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnAuthorizationGroupLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnAuthorizationGroupsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnAuthorizationGroupsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnAuthorizationGroup>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnAuthorizationGroup>) -> MsgVpnAuthorizationGroupsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnAuthorizationGroup>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnAuthorizationGroupLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnAuthorizationGroupLinks>) -> MsgVpnAuthorizationGroupsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnAuthorizationGroupLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnAuthorizationGroupsResponse {
    self.meta = meta;
    self
  }
