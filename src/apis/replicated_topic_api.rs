...
pub struct ReplicatedTopicApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> ReplicatedTopicApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> ReplicatedTopicApiClient<C> {
        ReplicatedTopicApiClient {
            configuration: configuration,
        }
    }
}

pub trait ReplicatedTopicApi {
...
impl<C: hyper::client::Connect>ReplicatedTopicApi for ReplicatedTopicApiClient<C> {
    fn get_msg_vpn_replicated_topics(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnReplicatedTopicsResponse, Error = Error<serde_json::Value>>> {
