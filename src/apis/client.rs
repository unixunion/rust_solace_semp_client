...
pub struct APIClient<C: hyper::client::Connect> {
  ...
  client_cert_authority_api: Box<::apis::ClientCertAuthorityApi>,
  ...
  domain_cert_authority_api: Box<::apis::DomainCertAuthorityApi>,
  ...
  virtual_hostname_api: Box<::apis::VirtualHostnameApi>,
}
...
impl<C: hyper::client::Connect> APIClient<C> {
  pub fn new(configuration: Configuration<C>) -> APIClient<C> {
    ...
    APIClient {
      ...
      client_cert_authority_api: Box::new(::apis::ClientCertAuthorityApiClient::new(rc.clone())),
      ...
      domain_cert_authority_api: Box::new(::apis::DomainCertAuthorityApiClient::new(rc.clone())),
      ...
      virtual_hostname_api: Box::new(::apis::VirtualHostnameApiClient::new(rc.clone())),
    }
  }
  ...
  pub fn client_cert_authority_api(&self) -> &::apis::ClientCertAuthorityApi{
    self.client_cert_authority_api.as_ref()
  }
  ...
  pub fn domain_cert_authority_api(&self) -> &::apis::DomainCertAuthorityApi{
    self.domain_cert_authority_api.as_ref()
  }
  ...
  pub fn virtual_hostname_api(&self) -> &::apis::VirtualHostnameApi{
    self.virtual_hostname_api.as_ref()
  }
