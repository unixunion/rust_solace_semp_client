...
pub struct MsgVpnReplicatedTopicsResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpnReplicatedTopic>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnReplicatedTopicLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnReplicatedTopicsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnReplicatedTopicsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnReplicatedTopic>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnReplicatedTopic>) -> MsgVpnReplicatedTopicsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnReplicatedTopic>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnReplicatedTopicLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnReplicatedTopicLinks>) -> MsgVpnReplicatedTopicsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnReplicatedTopicLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnReplicatedTopicsResponse {
    self.meta = meta;
    self
  }
