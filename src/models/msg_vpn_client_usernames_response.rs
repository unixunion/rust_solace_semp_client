...
pub struct MsgVpnClientUsernamesResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnClientUsername>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnClientUsernameLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnClientUsernamesResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnClientUsernamesResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnClientUsername>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnClientUsername>) -> MsgVpnClientUsernamesResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnClientUsername>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnClientUsernameLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnClientUsernameLinks>) -> MsgVpnClientUsernamesResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnClientUsernameLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnClientUsernamesResponse {
    self.meta = meta;
    self
  }
