...
impl MsgVpnQueueSubscription {
  pub fn new() -> MsgVpnQueueSubscription {
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnQueueSubscription {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_queue_name(mut self, queue_name: String) -> MsgVpnQueueSubscription {
    self.queue_name = Some(queue_name);
    self
  }
  ...
  pub fn with_subscription_topic(mut self, subscription_topic: String) -> MsgVpnQueueSubscription {
    self.subscription_topic = Some(subscription_topic);
    self
  }
