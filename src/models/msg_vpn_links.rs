...
pub struct MsgVpnLinks {
  ...
  /// The URI of this MsgVpn's distributedCaches collection. Available since 2.11.
  #[serde(rename = "distributedCachesUri", skip_serializing_if="Option::is_none")]
  distributed_caches_uri: Option<String>,
  /// The URI of this MsgVpn's dmrBridges collection. Available since 2.11.
  ...
  /// The URI of this MsgVpn's mqttRetainCaches collection. Available since 2.11.
