...
pub struct MsgVpnBridgeTlsTrustedCommonNameResponse {
  #[serde(rename = "data")]
  data: Option<::models::MsgVpnBridgeTlsTrustedCommonName>,
  #[serde(rename = "links")]
  links: Option<::models::MsgVpnBridgeTlsTrustedCommonNameLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnBridgeTlsTrustedCommonNameResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnBridgeTlsTrustedCommonNameResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnBridgeTlsTrustedCommonName) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnBridgeTlsTrustedCommonName) -> MsgVpnBridgeTlsTrustedCommonNameResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnBridgeTlsTrustedCommonName> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnBridgeTlsTrustedCommonNameLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnBridgeTlsTrustedCommonNameLinks) -> MsgVpnBridgeTlsTrustedCommonNameResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnBridgeTlsTrustedCommonNameLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnBridgeTlsTrustedCommonNameResponse {
    self.meta = meta;
    self
  }
