...
pub struct MsgVpnClientUsernameResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnClientUsername>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnClientUsernameLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnClientUsernameResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnClientUsernameResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnClientUsername) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnClientUsername) -> MsgVpnClientUsernameResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnClientUsername> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnClientUsernameLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnClientUsernameLinks) -> MsgVpnClientUsernameResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnClientUsernameLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnClientUsernameResponse {
    self.meta = meta;
    self
  }
