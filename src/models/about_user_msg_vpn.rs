...
impl AboutUserMsgVpn {
  pub fn new() -> AboutUserMsgVpn {
    AboutUserMsgVpn {
      access_level: None,
      msg_vpn_name: None
    }
  ...
  pub fn with_access_level(mut self, access_level: String) -> AboutUserMsgVpn {
    self.access_level = Some(access_level);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> AboutUserMsgVpn {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
