...
pub struct AboutApiResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::AboutApi>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::AboutApiLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl AboutApiResponse {
  pub fn new(meta: ::models::SempMeta) -> AboutApiResponse {
    AboutApiResponse {
      data: None,
      links: None,
      meta: meta
  ...
  pub fn set_data(&mut self, data: ::models::AboutApi) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::AboutApi) -> AboutApiResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::AboutApi> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::AboutApiLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::AboutApiLinks) -> AboutApiResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::AboutApiLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> AboutApiResponse {
    self.meta = meta;
    self
  }
