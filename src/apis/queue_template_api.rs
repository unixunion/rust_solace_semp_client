...
pub struct QueueTemplateApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> QueueTemplateApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> QueueTemplateApiClient<C> {
        QueueTemplateApiClient {
            configuration: configuration,
        }
    }
}

pub trait QueueTemplateApi {
...
impl<C: hyper::client::Connect>QueueTemplateApi for QueueTemplateApiClient<C> {
    fn get_msg_vpn_queue_templates(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnQueueTemplatesResponse, Error = Error<serde_json::Value>>> {
