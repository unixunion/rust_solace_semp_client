...
pub struct AboutUserMsgVpnLinks {
  /// The URI of this AboutUserMsgVpn object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl AboutUserMsgVpnLinks {
  pub fn new() -> AboutUserMsgVpnLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> AboutUserMsgVpnLinks {
    self.uri = Some(uri);
    self
  }
