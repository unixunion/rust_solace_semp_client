...
impl MsgVpnRestDeliveryPoint {
  pub fn new() -> MsgVpnRestDeliveryPoint {
  ...
  pub fn with_client_profile_name(mut self, client_profile_name: String) -> MsgVpnRestDeliveryPoint {
    self.client_profile_name = Some(client_profile_name);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> MsgVpnRestDeliveryPoint {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnRestDeliveryPoint {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_rest_delivery_point_name(mut self, rest_delivery_point_name: String) -> MsgVpnRestDeliveryPoint {
    self.rest_delivery_point_name = Some(rest_delivery_point_name);
    self
  }
  ...
  pub fn with_service(mut self, service: String) -> MsgVpnRestDeliveryPoint {
    self.service = Some(service);
    self
  }
  ...
  pub fn with_vendor(mut self, vendor: String) -> MsgVpnRestDeliveryPoint {
    self.vendor = Some(vendor);
    self
  }
