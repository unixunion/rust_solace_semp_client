...
pub struct MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
...
impl MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
  pub fn new() -> MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
  ...
  pub fn with_cache_name(mut self, cache_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
    self.cache_name = Some(cache_name);
    self
  }
  ...
  pub fn with_cluster_name(mut self, cluster_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
    self.cluster_name = Some(cluster_name);
    self
  }
  ...
  pub fn with_home_cluster_name(mut self, home_cluster_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
    self.home_cluster_name = Some(home_cluster_name);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnDistributedCacheClusterGlobalCachingHomeCluster {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
