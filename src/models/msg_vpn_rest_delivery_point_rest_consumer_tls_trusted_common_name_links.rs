...
pub struct MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks {
  /// The URI of this MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks {
  pub fn new() -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks {
    self.uri = Some(uri);
    self
  }
