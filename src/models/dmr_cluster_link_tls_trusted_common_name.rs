...
pub struct DmrClusterLinkTlsTrustedCommonName {
...
impl DmrClusterLinkTlsTrustedCommonName {
  pub fn new() -> DmrClusterLinkTlsTrustedCommonName {
  ...
  pub fn with_dmr_cluster_name(mut self, dmr_cluster_name: String) -> DmrClusterLinkTlsTrustedCommonName {
    self.dmr_cluster_name = Some(dmr_cluster_name);
    self
  }
  ...
  pub fn with_remote_node_name(mut self, remote_node_name: String) -> DmrClusterLinkTlsTrustedCommonName {
    self.remote_node_name = Some(remote_node_name);
    self
  }
  ...
  pub fn with_tls_trusted_common_name(mut self, tls_trusted_common_name: String) -> DmrClusterLinkTlsTrustedCommonName {
    self.tls_trusted_common_name = Some(tls_trusted_common_name);
    self
  }
