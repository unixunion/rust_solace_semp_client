...
pub struct MsgVpnReplayLogResponse {
      #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnReplayLog>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnReplayLogLinks>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnReplayLogResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnReplayLogResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnReplayLog) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnReplayLog) -> MsgVpnReplayLogResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnReplayLog> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnReplayLogLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnReplayLogLinks) -> MsgVpnReplayLogResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnReplayLogLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnReplayLogResponse {
    self.meta = meta;
    self
  }
