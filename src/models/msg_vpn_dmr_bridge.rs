...
impl MsgVpnDmrBridge {
  pub fn new() -> MsgVpnDmrBridge {
    MsgVpnDmrBridge {
      msg_vpn_name: None,
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnDmrBridge {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_remote_msg_vpn_name(mut self, remote_msg_vpn_name: String) -> MsgVpnDmrBridge {
    self.remote_msg_vpn_name = Some(remote_msg_vpn_name);
    self
  }
  ...
  pub fn with_remote_node_name(mut self, remote_node_name: String) -> MsgVpnDmrBridge {
    self.remote_node_name = Some(remote_node_name);
    self
  }
