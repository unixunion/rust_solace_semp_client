...
pub struct MsgVpnMqttRetainCacheResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnMqttRetainCache>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnMqttRetainCacheLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnMqttRetainCacheResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnMqttRetainCacheResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnMqttRetainCache) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnMqttRetainCache) -> MsgVpnMqttRetainCacheResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnMqttRetainCache> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnMqttRetainCacheLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnMqttRetainCacheLinks) -> MsgVpnMqttRetainCacheResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnMqttRetainCacheLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnMqttRetainCacheResponse {
    self.meta = meta;
    self
  }
