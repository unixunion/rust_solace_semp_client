...
pub struct MsgVpnBridgeRemoteSubscription {
  ...
  /// Flag the topic as deliver-always instead of with the configured deliver-to-one remote-priority value for the bridge. A given topic may be deliver-to-one or deliver-always but not both.
...
impl MsgVpnBridgeRemoteSubscription {
  pub fn new() -> MsgVpnBridgeRemoteSubscription {
    MsgVpnBridgeRemoteSubscription {
      bridge_name: None,
      bridge_virtual_router: None,
      deliver_always_enabled: None,
      msg_vpn_name: None,
      remote_subscription_topic: None
    }
  }
  ...
  pub fn with_bridge_name(mut self, bridge_name: String) -> MsgVpnBridgeRemoteSubscription {
    self.bridge_name = Some(bridge_name);
    self
  }
  ...
  pub fn with_bridge_virtual_router(mut self, bridge_virtual_router: String) -> MsgVpnBridgeRemoteSubscription {
    self.bridge_virtual_router = Some(bridge_virtual_router);
    self
  }
  ...
  pub fn set_deliver_always_enabled(&mut self, deliver_always_enabled: bool) {
    self.deliver_always_enabled = Some(deliver_always_enabled);
  }

  pub fn with_deliver_always_enabled(mut self, deliver_always_enabled: bool) -> MsgVpnBridgeRemoteSubscription {
    self.deliver_always_enabled = Some(deliver_always_enabled);
    self
  }

  pub fn deliver_always_enabled(&self) -> Option<&bool> {
    self.deliver_always_enabled.as_ref()
  }

  pub fn reset_deliver_always_enabled(&mut self) {
    self.deliver_always_enabled = None;
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnBridgeRemoteSubscription {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_remote_subscription_topic(&mut self, remote_subscription_topic: String) {
    self.remote_subscription_topic = Some(remote_subscription_topic);
  }

  pub fn with_remote_subscription_topic(mut self, remote_subscription_topic: String) -> MsgVpnBridgeRemoteSubscription {
    self.remote_subscription_topic = Some(remote_subscription_topic);
    self
  }

  pub fn remote_subscription_topic(&self) -> Option<&String> {
    self.remote_subscription_topic.as_ref()
  }

  pub fn reset_remote_subscription_topic(&mut self) {
    self.remote_subscription_topic = None;
  }
