...
pub struct MsgVpnResponse {
  #[serde(rename = "data")]
  data: Option<::models::MsgVpn>,
  #[serde(rename = "links")]
  links: Option<::models::MsgVpnLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnResponse {
    MsgVpnResponse {
      data: None,
      links: None,
      meta: meta
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpn) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpn) -> MsgVpnResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpn> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnLinks) -> MsgVpnResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnResponse {
    self.meta = meta;
    self
  }
