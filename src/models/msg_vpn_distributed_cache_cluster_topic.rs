...
pub struct MsgVpnDistributedCacheClusterTopic {
...
impl MsgVpnDistributedCacheClusterTopic {
  pub fn new() -> MsgVpnDistributedCacheClusterTopic {
  ...
  pub fn with_cache_name(mut self, cache_name: String) -> MsgVpnDistributedCacheClusterTopic {
    self.cache_name = Some(cache_name);
    self
  }
  ...
  pub fn with_cluster_name(mut self, cluster_name: String) -> MsgVpnDistributedCacheClusterTopic {
    self.cluster_name = Some(cluster_name);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnDistributedCacheClusterTopic {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_topic(mut self, topic: String) -> MsgVpnDistributedCacheClusterTopic {
    self.topic = Some(topic);
    self
  }
