...
impl EventThresholdByValue {
  pub fn new() -> EventThresholdByValue {
  ...
  pub fn with_clear_value(mut self, clear_value: i64) -> EventThresholdByValue {
    self.clear_value = Some(clear_value);
    self
  }
  ...
  pub fn with_set_value(mut self, set_value: i64) -> EventThresholdByValue {
    self.set_value = Some(set_value);
    self
  }
