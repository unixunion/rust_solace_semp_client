...
pub struct TopicEndpointTemplateApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> TopicEndpointTemplateApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> TopicEndpointTemplateApiClient<C> {
        TopicEndpointTemplateApiClient {
            configuration: configuration,
        }
    }
}

pub trait TopicEndpointTemplateApi {
...
impl<C: hyper::client::Connect>TopicEndpointTemplateApi for TopicEndpointTemplateApiClient<C> {
    fn get_msg_vpn_topic_endpoint_templates(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnTopicEndpointTemplatesResponse, Error = Error<serde_json::Value>>> {
