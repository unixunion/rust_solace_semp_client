...
pub struct MsgVpnTopicEndpointTemplate {
  ...
  #[serde(rename = "topicEndpointNameFilter", skip_serializing_if="Option::is_none")]
  topic_endpoint_name_filter: Option<String>,
  /// The name of the Topic Endpoint Template.
  #[serde(rename = "topicEndpointTemplateName", skip_serializing_if="Option::is_none")]
  topic_endpoint_template_name: Option<String>
}

impl MsgVpnTopicEndpointTemplate {
  pub fn new() -> MsgVpnTopicEndpointTemplate {
    MsgVpnTopicEndpointTemplate {
      ...
      topic_endpoint_name_filter: None,
      topic_endpoint_template_name: None
    }
  }
  ...
  pub fn with_access_type(mut self, access_type: String) -> MsgVpnTopicEndpointTemplate {
    self.access_type = Some(access_type);
    self
  }
  ...
  pub fn with_consumer_ack_propagation_enabled(mut self, consumer_ack_propagation_enabled: bool) -> MsgVpnTopicEndpointTemplate {
    self.consumer_ack_propagation_enabled = Some(consumer_ack_propagation_enabled);
    self
  }
  ...
  pub fn with_dead_msg_queue(mut self, dead_msg_queue: String) -> MsgVpnTopicEndpointTemplate {
    self.dead_msg_queue = Some(dead_msg_queue);
    self
  }
  ...
  pub fn with_event_bind_count_threshold(mut self, event_bind_count_threshold: ::models::EventThreshold) -> MsgVpnTopicEndpointTemplate {
    self.event_bind_count_threshold = Some(event_bind_count_threshold);
    self
  }
  ...
  pub fn with_event_msg_spool_usage_threshold(mut self, event_msg_spool_usage_threshold: ::models::EventThreshold) -> MsgVpnTopicEndpointTemplate {
    self.event_msg_spool_usage_threshold = Some(event_msg_spool_usage_threshold);
    self
  }
  ...
  pub fn with_event_reject_low_priority_msg_limit_threshold(mut self, event_reject_low_priority_msg_limit_threshold: ::models::EventThreshold) -> MsgVpnTopicEndpointTemplate {
    self.event_reject_low_priority_msg_limit_threshold = Some(event_reject_low_priority_msg_limit_threshold);
    self
  }
  ...
  pub fn with_max_bind_count(mut self, max_bind_count: i64) -> MsgVpnTopicEndpointTemplate {
    self.max_bind_count = Some(max_bind_count);
    self
  }
  ...
  pub fn with_max_delivered_unacked_msgs_per_flow(mut self, max_delivered_unacked_msgs_per_flow: i64) -> MsgVpnTopicEndpointTemplate {
    self.max_delivered_unacked_msgs_per_flow = Some(max_delivered_unacked_msgs_per_flow);
    self
  }
  ...
  pub fn with_max_msg_size(mut self, max_msg_size: i32) -> MsgVpnTopicEndpointTemplate {
    self.max_msg_size = Some(max_msg_size);
    self
  }
  ...
  pub fn with_max_msg_spool_usage(mut self, max_msg_spool_usage: i64) -> MsgVpnTopicEndpointTemplate {
    self.max_msg_spool_usage = Some(max_msg_spool_usage);
    self
  }
  ...
  pub fn with_max_redelivery_count(mut self, max_redelivery_count: i64) -> MsgVpnTopicEndpointTemplate {
    self.max_redelivery_count = Some(max_redelivery_count);
    self
  }
  ...
  pub fn with_max_ttl(mut self, max_ttl: i64) -> MsgVpnTopicEndpointTemplate {
    self.max_ttl = Some(max_ttl);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnTopicEndpointTemplate {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_permission(mut self, permission: String) -> MsgVpnTopicEndpointTemplate {
    self.permission = Some(permission);
    self
  }
  ...
  pub fn with_redelivery_enabled(mut self, redelivery_enabled: bool) -> MsgVpnTopicEndpointTemplate {
    self.redelivery_enabled = Some(redelivery_enabled);
    self
  }
  ...
  pub fn with_reject_low_priority_msg_enabled(mut self, reject_low_priority_msg_enabled: bool) -> MsgVpnTopicEndpointTemplate {
    self.reject_low_priority_msg_enabled = Some(reject_low_priority_msg_enabled);
    self
  }
  ...
  pub fn with_reject_low_priority_msg_limit(mut self, reject_low_priority_msg_limit: i64) -> MsgVpnTopicEndpointTemplate {
    self.reject_low_priority_msg_limit = Some(reject_low_priority_msg_limit);
    self
  }
  ...
  pub fn with_reject_msg_to_sender_on_discard_behavior(mut self, reject_msg_to_sender_on_discard_behavior: String) -> MsgVpnTopicEndpointTemplate {
    self.reject_msg_to_sender_on_discard_behavior = Some(reject_msg_to_sender_on_discard_behavior);
    self
  }
  ...
  pub fn with_respect_msg_priority_enabled(mut self, respect_msg_priority_enabled: bool) -> MsgVpnTopicEndpointTemplate {
    self.respect_msg_priority_enabled = Some(respect_msg_priority_enabled);
    self
  }
  ...
  pub fn with_respect_ttl_enabled(mut self, respect_ttl_enabled: bool) -> MsgVpnTopicEndpointTemplate {
    self.respect_ttl_enabled = Some(respect_ttl_enabled);
    self
  }
  ...
  pub fn set_topic_endpoint_name_filter(&mut self, topic_endpoint_name_filter: String) {
    self.topic_endpoint_name_filter = Some(topic_endpoint_name_filter);
  }

  pub fn with_topic_endpoint_name_filter(mut self, topic_endpoint_name_filter: String) -> MsgVpnTopicEndpointTemplate {
    self.topic_endpoint_name_filter = Some(topic_endpoint_name_filter);
    self
  }

  pub fn topic_endpoint_name_filter(&self) -> Option<&String> {
    self.topic_endpoint_name_filter.as_ref()
  }

  pub fn reset_topic_endpoint_name_filter(&mut self) {
    self.topic_endpoint_name_filter = None;
  }

  pub fn set_topic_endpoint_template_name(&mut self, topic_endpoint_template_name: String) {
    self.topic_endpoint_template_name = Some(topic_endpoint_template_name);
  }

  pub fn with_topic_endpoint_template_name(mut self, topic_endpoint_template_name: String) -> MsgVpnTopicEndpointTemplate {
    self.topic_endpoint_template_name = Some(topic_endpoint_template_name);
    self
  }

  pub fn topic_endpoint_template_name(&self) -> Option<&String> {
    self.topic_endpoint_template_name.as_ref()
  }

  pub fn reset_topic_endpoint_template_name(&mut self) {
    self.topic_endpoint_template_name = None;
  }
