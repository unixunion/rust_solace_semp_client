...
pub struct SystemInformationResponse {
  ...
  data: Option<::models::SystemInformation>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::SystemInformationLinks>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl SystemInformationResponse {
  pub fn new(meta: ::models::SempMeta) -> SystemInformationResponse {
  ...
  pub fn set_data(&mut self, data: ::models::SystemInformation) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::SystemInformation) -> SystemInformationResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::SystemInformation> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::SystemInformationLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::SystemInformationLinks) -> SystemInformationResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::SystemInformationLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> SystemInformationResponse {
    self.meta = meta;
    self
  }
