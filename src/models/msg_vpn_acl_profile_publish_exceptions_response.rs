...
pub struct MsgVpnAclProfilePublishExceptionsResponse {
      #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnAclProfilePublishException>>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnAclProfilePublishExceptionLinks>>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnAclProfilePublishExceptionsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnAclProfilePublishExceptionsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnAclProfilePublishException>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnAclProfilePublishException>) -> MsgVpnAclProfilePublishExceptionsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnAclProfilePublishException>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnAclProfilePublishExceptionLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnAclProfilePublishExceptionLinks>) -> MsgVpnAclProfilePublishExceptionsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnAclProfilePublishExceptionLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnAclProfilePublishExceptionsResponse {
    self.meta = meta;
    self
  }
