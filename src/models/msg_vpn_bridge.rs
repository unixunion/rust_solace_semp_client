...
pub struct MsgVpnBridge {
  /// The name of the Message VPN Bridge.
  #[serde(rename = "bridgeName")]
  bridge_name: Option<String>,
  /// Specify whether the Message VPN Bridge is used for the Primary or Backup Router. The allowed values and their meaning are:  <pre> \"primary\" - The Message VPN Bridge is used for the Primary Router. \"backup\" - The Message VPN Bridge is used for the Backup Router. </pre> 
  #[serde(rename = "bridgeVirtualRouter")]
  bridge_virtual_router: Option<String>,
  /// Enable or disable the Message VPN Bridge. The default value is `false`.
  #[serde(rename = "enabled")]
  enabled: Option<bool>,
  /// The maximum number of hops (intermediate routers through which data must pass between source and destination) that can occur before the message is discarded. When the Message VPN Bridge sends a message to the remote router, the message TTL value is assigned to the lower of the message current TTL or this value. The default value is `8`.
  #[serde(rename = "maxTtl")]
  max_ttl: Option<i64>,
  /// The name of the Message VPN.
  #[serde(rename = "msgVpnName")]
  msg_vpn_name: Option<String>,
  /// The Client Username the Message VPN Bridge uses to login to the Remote Message VPN. The default value is `\"\"`.
  #[serde(rename = "remoteAuthenticationBasicClientUsername")]
  ...
  #[serde(rename = "remoteAuthenticationBasicPassword")]
  remote_authentication_basic_password: Option<String>,
  /// The Authentication Scheme for the Remote Message VPN. The default value is `\"basic\"`. The allowed values and their meaning are:  <pre> \"basic\" - Basic Authentication Scheme (via username and password). \"client-certificate\" - Client Certificate Authentication Scheme (via certificate-file). \"not-applicable\" - Monitor Only Value. </pre> 
  #[serde(rename = "remoteAuthenticationScheme")]
  remote_authentication_scheme: Option<String>,
  /// The maximum number of attempts to establish connection to the Remote Message VPN. The default value is `0`.
  #[serde(rename = "remoteConnectionRetryCount")]
  ...
  #[serde(rename = "remoteConnectionRetryDelay")]
  ...
  #[serde(rename = "remoteDeliverToOnePriority")]
  remote_deliver_to_one_priority: Option<String>,
  /// The list of of cipher suites supported for TLS connections to the Remote Message VPN. The default value is `\"ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES256-SHA384:ECDHE-RSA-AES256-SHA:AES256-GCM-SHA384:AES256-SHA256:AES256-SHA:ECDHE-RSA-DES-CBC3-SHA:DES-CBC3-SHA:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES128-SHA:AES128-GCM-SHA256:AES128-SHA256:AES128-SHA\"`.
