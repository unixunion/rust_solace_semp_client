...
pub struct DmrClusterResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::DmrCluster>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::DmrClusterLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl DmrClusterResponse {
  pub fn new(meta: ::models::SempMeta) -> DmrClusterResponse {
    DmrClusterResponse {
      data: None,
      links: None,
      meta: meta
  ...
  pub fn set_data(&mut self, data: ::models::DmrCluster) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::DmrCluster) -> DmrClusterResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::DmrCluster> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::DmrClusterLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::DmrClusterLinks) -> DmrClusterResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::DmrClusterLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> DmrClusterResponse {
    self.meta = meta;
    self
  }
