...
pub struct MsgVpnDistributedCache {
  ...
  #[serde(rename = "scheduledDeleteMsgDayList", skip_serializing_if="Option::is_none")]
  scheduled_delete_msg_day_list: Option<String>,
  ...
  #[serde(rename = "scheduledDeleteMsgTimeList", skip_serializing_if="Option::is_none")]
  scheduled_delete_msg_time_list: Option<String>
}

impl MsgVpnDistributedCache {
  pub fn new() -> MsgVpnDistributedCache {
    MsgVpnDistributedCache {
      cache_name: None,
      enabled: None,
      heartbeat: None,
      msg_vpn_name: None,
      scheduled_delete_msg_day_list: None,
      scheduled_delete_msg_time_list: None
    }
  }
  ...
  pub fn with_cache_name(mut self, cache_name: String) -> MsgVpnDistributedCache {
    self.cache_name = Some(cache_name);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> MsgVpnDistributedCache {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn set_heartbeat(&mut self, heartbeat: i64) {
    self.heartbeat = Some(heartbeat);
  }

  pub fn with_heartbeat(mut self, heartbeat: i64) -> MsgVpnDistributedCache {
    self.heartbeat = Some(heartbeat);
    self
  }

  pub fn heartbeat(&self) -> Option<&i64> {
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnDistributedCache {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_scheduled_delete_msg_day_list(&mut self, scheduled_delete_msg_day_list: String) {
    self.scheduled_delete_msg_day_list = Some(scheduled_delete_msg_day_list);
  }

  pub fn with_scheduled_delete_msg_day_list(mut self, scheduled_delete_msg_day_list: String) -> MsgVpnDistributedCache {
    self.scheduled_delete_msg_day_list = Some(scheduled_delete_msg_day_list);
    self
  }

  pub fn scheduled_delete_msg_day_list(&self) -> Option<&String> {
    self.scheduled_delete_msg_day_list.as_ref()
  }

  pub fn reset_scheduled_delete_msg_day_list(&mut self) {
    self.scheduled_delete_msg_day_list = None;
  }

  pub fn set_scheduled_delete_msg_time_list(&mut self, scheduled_delete_msg_time_list: String) {
    self.scheduled_delete_msg_time_list = Some(scheduled_delete_msg_time_list);
  }

  pub fn with_scheduled_delete_msg_time_list(mut self, scheduled_delete_msg_time_list: String) -> MsgVpnDistributedCache {
    self.scheduled_delete_msg_time_list = Some(scheduled_delete_msg_time_list);
    self
  }

  pub fn scheduled_delete_msg_time_list(&self) -> Option<&String> {
    self.scheduled_delete_msg_time_list.as_ref()
  }

  pub fn reset_scheduled_delete_msg_time_list(&mut self) {
    self.scheduled_delete_msg_time_list = None;
  }
