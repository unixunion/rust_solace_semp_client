...
pub struct AboutApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> AboutApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> AboutApiClient<C> {
        AboutApiClient {
...
pub trait AboutApi {
    fn get_about(&self, opaque_password: &str, select: Vec<String>) -> Box<Future<Item = ::models::AboutResponse, Error = Error<serde_json::Value>>>;
    fn get_about_api(&self, ) -> Box<Future<Item = ::models::AboutApiResponse, Error = Error<serde_json::Value>>>;
    fn get_about_user(&self, opaque_password: &str, select: Vec<String>) -> Box<Future<Item = ::models::AboutUserResponse, Error = Error<serde_json::Value>>>;
    fn get_about_user_msg_vpn(&self, msg_vpn_name: &str, opaque_password: &str, select: Vec<String>) -> Box<Future<Item = ::models::AboutUserMsgVpnResponse, Error = Error<serde_json::Value>>>;
    fn get_about_user_msg_vpns(&self, count: i32, cursor: &str, opaque_password: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::AboutUserMsgVpnsResponse, Error = Error<serde_json::Value>>>;
}


impl<C: hyper::client::Connect>AboutApi for AboutApiClient<C> {
    fn get_about(&self, opaque_password: &str, select: Vec<String>) -> Box<Future<Item = ::models::AboutResponse, Error = Error<serde_json::Value>>> {
