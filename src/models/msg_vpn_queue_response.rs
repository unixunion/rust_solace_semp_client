...
pub struct MsgVpnQueueResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnQueue>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnQueueLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnQueueResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnQueueResponse {
    MsgVpnQueueResponse {
      data: None,
      links: None,
      meta: meta
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnQueue) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnQueue) -> MsgVpnQueueResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnQueue> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnQueueLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnQueueLinks) -> MsgVpnQueueResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnQueueLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnQueueResponse {
    self.meta = meta;
    self
  }
