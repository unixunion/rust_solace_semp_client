...
impl AboutApi {
  pub fn new(platform: String, semp_version: String) -> AboutApi {
    AboutApi {
      platform: platform,
  ...
  pub fn with_platform(mut self, platform: String) -> AboutApi {
    self.platform = platform;
    self
  }
  ...
  pub fn with_semp_version(mut self, semp_version: String) -> AboutApi {
    self.semp_version = semp_version;
    self
  }
