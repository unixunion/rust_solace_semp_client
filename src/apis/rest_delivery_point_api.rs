...
pub struct RestDeliveryPointApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> RestDeliveryPointApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> RestDeliveryPointApiClient<C> {
        RestDeliveryPointApiClient {
            configuration: configuration,
        }
    }
}

pub trait RestDeliveryPointApi {
...
impl<C: hyper::client::Connect>RestDeliveryPointApi for RestDeliveryPointApiClient<C> {
    fn get_msg_vpn_rest_delivery_points(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnRestDeliveryPointsResponse, Error = Error<serde_json::Value>>> {
