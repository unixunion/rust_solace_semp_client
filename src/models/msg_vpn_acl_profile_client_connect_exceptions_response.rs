...
pub struct MsgVpnAclProfileClientConnectExceptionsResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::MsgVpnAclProfileClientConnectException>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::MsgVpnAclProfileClientConnectExceptionLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnAclProfileClientConnectExceptionsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnAclProfileClientConnectExceptionsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnAclProfileClientConnectException>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnAclProfileClientConnectException>) -> MsgVpnAclProfileClientConnectExceptionsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnAclProfileClientConnectException>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnAclProfileClientConnectExceptionLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnAclProfileClientConnectExceptionLinks>) -> MsgVpnAclProfileClientConnectExceptionsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnAclProfileClientConnectExceptionLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnAclProfileClientConnectExceptionsResponse {
    self.meta = meta;
    self
  }
