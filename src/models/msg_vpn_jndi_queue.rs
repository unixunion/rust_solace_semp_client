...
impl MsgVpnJndiQueue {
  pub fn new() -> MsgVpnJndiQueue {
    MsgVpnJndiQueue {
      msg_vpn_name: None,
      physical_name: None,
      queue_name: None
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnJndiQueue {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_physical_name(&mut self, physical_name: String) {
    self.physical_name = Some(physical_name);
  }

  pub fn with_physical_name(mut self, physical_name: String) -> MsgVpnJndiQueue {
    self.physical_name = Some(physical_name);
    self
  }

  pub fn physical_name(&self) -> Option<&String> {
    self.physical_name.as_ref()
  }

  pub fn reset_physical_name(&mut self) {
  ...
  pub fn with_queue_name(mut self, queue_name: String) -> MsgVpnJndiQueue {
    self.queue_name = Some(queue_name);
    self
  }
