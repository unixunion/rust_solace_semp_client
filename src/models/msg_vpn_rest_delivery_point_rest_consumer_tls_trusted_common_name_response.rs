...
pub struct MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonNameResponse {
    self.meta = meta;
    self
  }
