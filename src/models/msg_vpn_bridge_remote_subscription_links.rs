...
pub struct MsgVpnBridgeRemoteSubscriptionLinks {
  /// The URI of this MsgVpnBridgeRemoteSubscription object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnBridgeRemoteSubscriptionLinks {
  pub fn new() -> MsgVpnBridgeRemoteSubscriptionLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnBridgeRemoteSubscriptionLinks {
    self.uri = Some(uri);
    self
  }
