...
pub struct MsgVpnTopicEndpointsResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpnTopicEndpoint>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnTopicEndpointLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnTopicEndpointsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnTopicEndpointsResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnTopicEndpoint>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnTopicEndpoint>) -> MsgVpnTopicEndpointsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnTopicEndpoint>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnTopicEndpointLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnTopicEndpointLinks>) -> MsgVpnTopicEndpointsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnTopicEndpointLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnTopicEndpointsResponse {
    self.meta = meta;
    self
  }
