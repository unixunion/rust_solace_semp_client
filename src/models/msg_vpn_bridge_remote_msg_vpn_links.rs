...
pub struct MsgVpnBridgeRemoteMsgVpnLinks {
  /// The URI of this MsgVpnBridgeRemoteMsgVpn object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnBridgeRemoteMsgVpnLinks {
  pub fn new() -> MsgVpnBridgeRemoteMsgVpnLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnBridgeRemoteMsgVpnLinks {
    self.uri = Some(uri);
    self
  }
