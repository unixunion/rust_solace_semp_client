...
pub struct MsgVpnBridgeTlsTrustedCommonNameLinks {
  /// The URI of this MsgVpnBridgeTlsTrustedCommonName object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnBridgeTlsTrustedCommonNameLinks {
  pub fn new() -> MsgVpnBridgeTlsTrustedCommonNameLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnBridgeTlsTrustedCommonNameLinks {
    self.uri = Some(uri);
    self
  }
