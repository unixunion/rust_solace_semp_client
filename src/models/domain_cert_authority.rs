...
pub struct DomainCertAuthority {
...
impl DomainCertAuthority {
  pub fn new() -> DomainCertAuthority {
    DomainCertAuthority {
  ...
  pub fn with_cert_authority_name(mut self, cert_authority_name: String) -> DomainCertAuthority {
    self.cert_authority_name = Some(cert_authority_name);
    self
  }
  ...
  pub fn with_cert_content(mut self, cert_content: String) -> DomainCertAuthority {
    self.cert_content = Some(cert_content);
    self
  }
