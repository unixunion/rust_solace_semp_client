...
pub struct MsgVpnMqttSessionSubscription {
  ...
  /// The Virtual Router of the MQTT Session. The allowed values and their meaning are:  <pre> \"primary\" - MQTT Session belongs to the primary Virtual Router. \"backup\" - MQTT Session belongs to the backup Virtual Router. </pre> 
...
impl MsgVpnMqttSessionSubscription {
  pub fn new() -> MsgVpnMqttSessionSubscription {
  ...
  pub fn with_mqtt_session_client_id(mut self, mqtt_session_client_id: String) -> MsgVpnMqttSessionSubscription {
    self.mqtt_session_client_id = Some(mqtt_session_client_id);
    self
  }
  ...
  pub fn with_mqtt_session_virtual_router(mut self, mqtt_session_virtual_router: String) -> MsgVpnMqttSessionSubscription {
    self.mqtt_session_virtual_router = Some(mqtt_session_virtual_router);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnMqttSessionSubscription {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_subscription_qos(&mut self, subscription_qos: i64) {
    self.subscription_qos = Some(subscription_qos);
  }

  pub fn with_subscription_qos(mut self, subscription_qos: i64) -> MsgVpnMqttSessionSubscription {
    self.subscription_qos = Some(subscription_qos);
    self
  }

  pub fn subscription_qos(&self) -> Option<&i64> {
    self.subscription_qos.as_ref()
  }

  pub fn reset_subscription_qos(&mut self) {
    self.subscription_qos = None;
  }

  pub fn set_subscription_topic(&mut self, subscription_topic: String) {
    self.subscription_topic = Some(subscription_topic);
  }

  pub fn with_subscription_topic(mut self, subscription_topic: String) -> MsgVpnMqttSessionSubscription {
    self.subscription_topic = Some(subscription_topic);
    self
  }

  pub fn subscription_topic(&self) -> Option<&String> {
    self.subscription_topic.as_ref()
  }

  pub fn reset_subscription_topic(&mut self) {
