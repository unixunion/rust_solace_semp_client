...
pub struct MsgVpnAclProfileSubscribeExceptionLinks {
  /// The URI of this MsgVpnAclProfileSubscribeException object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnAclProfileSubscribeExceptionLinks {
  pub fn new() -> MsgVpnAclProfileSubscribeExceptionLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnAclProfileSubscribeExceptionLinks {
    self.uri = Some(uri);
    self
  }
