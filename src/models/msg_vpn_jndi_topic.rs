...
impl MsgVpnJndiTopic {
  pub fn new() -> MsgVpnJndiTopic {
    MsgVpnJndiTopic {
      msg_vpn_name: None,
      physical_name: None,
      topic_name: None
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnJndiTopic {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn with_physical_name(mut self, physical_name: String) -> MsgVpnJndiTopic {
    self.physical_name = Some(physical_name);
    self
  }
  ...
  pub fn with_topic_name(mut self, topic_name: String) -> MsgVpnJndiTopic {
    self.topic_name = Some(topic_name);
    self
  }
