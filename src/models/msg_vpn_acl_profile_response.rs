...
pub struct MsgVpnAclProfileResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnAclProfile>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnAclProfileLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnAclProfileResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnAclProfileResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnAclProfile) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnAclProfile) -> MsgVpnAclProfileResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnAclProfile> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnAclProfileLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnAclProfileLinks) -> MsgVpnAclProfileResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnAclProfileLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnAclProfileResponse {
    self.meta = meta;
    self
  }
