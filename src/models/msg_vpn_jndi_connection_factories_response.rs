...
pub struct MsgVpnJndiConnectionFactoriesResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpnJndiConnectionFactory>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnJndiConnectionFactoryLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnJndiConnectionFactoriesResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnJndiConnectionFactoriesResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnJndiConnectionFactory>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnJndiConnectionFactory>) -> MsgVpnJndiConnectionFactoriesResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnJndiConnectionFactory>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnJndiConnectionFactoryLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnJndiConnectionFactoryLinks>) -> MsgVpnJndiConnectionFactoriesResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnJndiConnectionFactoryLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnJndiConnectionFactoriesResponse {
    self.meta = meta;
    self
  }
