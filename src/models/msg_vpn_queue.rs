...
pub struct MsgVpnQueue {
  ...
  /// Enable or disable the outgoing (egress) flow of messages from the Queue. The default value is `false`.
  ...
  /// Enable or disable the incoming (ingress) flow of messages to the Queue. The default value is `false`.
  #[serde(rename = "ingressEnabled")]
  ingress_enabled: Option<bool>,
  /// The maximum number of simultaneous clients bound to the Queue. The default value is `1000`.
