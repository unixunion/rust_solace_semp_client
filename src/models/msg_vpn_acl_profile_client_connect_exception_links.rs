...
pub struct MsgVpnAclProfileClientConnectExceptionLinks {
  /// The URI of this MsgVpnAclProfileClientConnectException object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnAclProfileClientConnectExceptionLinks {
  pub fn new() -> MsgVpnAclProfileClientConnectExceptionLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnAclProfileClientConnectExceptionLinks {
    self.uri = Some(uri);
    self
  }
