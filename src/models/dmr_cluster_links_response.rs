...
pub struct DmrClusterLinksResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::DmrClusterLink>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::DmrClusterLinkLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl DmrClusterLinksResponse {
  pub fn new(meta: ::models::SempMeta) -> DmrClusterLinksResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::DmrClusterLink>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::DmrClusterLink>) -> DmrClusterLinksResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::DmrClusterLink>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::DmrClusterLinkLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::DmrClusterLinkLinks>) -> DmrClusterLinksResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::DmrClusterLinkLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> DmrClusterLinksResponse {
    self.meta = meta;
    self
  }
