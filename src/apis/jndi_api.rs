...
pub struct JndiApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> JndiApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> JndiApiClient<C> {
        JndiApiClient {
...
pub trait JndiApi {
    ...
    fn get_msg_vpn_jndi_queues(&self, msg_vpn_name: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnJndiQueuesResponse, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>JndiApi for JndiApiClient<C> {
    fn get_msg_vpn_jndi_connection_factories(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnJndiConnectionFactoriesResponse, Error = Error<serde_json::Value>>> {
