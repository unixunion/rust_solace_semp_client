...
pub struct MsgVpnJndiTopicResponse {
      #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnJndiTopic>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnJndiTopicLinks>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnJndiTopicResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnJndiTopicResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnJndiTopic) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnJndiTopic) -> MsgVpnJndiTopicResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnJndiTopic> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnJndiTopicLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnJndiTopicLinks) -> MsgVpnJndiTopicResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnJndiTopicLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnJndiTopicResponse {
    self.meta = meta;
    self
  }
