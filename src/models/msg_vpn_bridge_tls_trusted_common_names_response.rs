...
pub struct MsgVpnBridgeTlsTrustedCommonNamesResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpnBridgeTlsTrustedCommonName>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnBridgeTlsTrustedCommonNameLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnBridgeTlsTrustedCommonNamesResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnBridgeTlsTrustedCommonNamesResponse {
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpnBridgeTlsTrustedCommonName>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpnBridgeTlsTrustedCommonName>) -> MsgVpnBridgeTlsTrustedCommonNamesResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpnBridgeTlsTrustedCommonName>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnBridgeTlsTrustedCommonNameLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnBridgeTlsTrustedCommonNameLinks>) -> MsgVpnBridgeTlsTrustedCommonNamesResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnBridgeTlsTrustedCommonNameLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnBridgeTlsTrustedCommonNamesResponse {
    self.meta = meta;
    self
  }
