...
pub struct DmrClusterLinks {
  /// The URI of this DmrCluster's links collection.
  #[serde(rename = "linksUri", skip_serializing_if="Option::is_none")]
  links_uri: Option<String>,
  /// The URI of this DmrCluster object.
  #[serde(rename = "uri", skip_serializing_if="Option::is_none")]
  uri: Option<String>
}

impl DmrClusterLinks {
  pub fn new() -> DmrClusterLinks {
    DmrClusterLinks {
      links_uri: None,
      uri: None
    }
  ...
  pub fn set_links_uri(&mut self, links_uri: String) {
    self.links_uri = Some(links_uri);
  }

  pub fn with_links_uri(mut self, links_uri: String) -> DmrClusterLinks {
    self.links_uri = Some(links_uri);
    self
  }

  pub fn links_uri(&self) -> Option<&String> {
    self.links_uri.as_ref()
  }

  pub fn reset_links_uri(&mut self) {
    self.links_uri = None;
  }
  ...
  pub fn with_uri(mut self, uri: String) -> DmrClusterLinks {
    self.uri = Some(uri);
    self
  }
