...
pub struct MqttRetainCacheApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> MqttRetainCacheApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> MqttRetainCacheApiClient<C> {
        MqttRetainCacheApiClient {
            configuration: configuration,
        }
    }
}

pub trait MqttRetainCacheApi {
...
impl<C: hyper::client::Connect>MqttRetainCacheApi for MqttRetainCacheApiClient<C> {
    fn get_msg_vpn_mqtt_retain_caches(&self, msg_vpn_name: &str, count: i32, cursor: &str, _where: Vec<String>, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnMqttRetainCachesResponse, Error = Error<serde_json::Value>>> {
