...
pub struct MsgVpnRestDeliveryPointRestConsumer {
  ...
  #[serde(rename = "authenticationHttpHeaderName", skip_serializing_if="Option::is_none")]
  authentication_http_header_name: Option<String>,
  ...
  #[serde(rename = "authenticationHttpHeaderValue", skip_serializing_if="Option::is_none")]
  authentication_http_header_value: Option<String>,
  /// The OAuth client ID. The default value is `\"\"`. Available since 2.19.
  #[serde(rename = "authenticationOauthClientId", skip_serializing_if="Option::is_none")]
  authentication_oauth_client_id: Option<String>,
  /// The OAuth scope. The default value is `\"\"`. Available since 2.19.
  #[serde(rename = "authenticationOauthClientScope", skip_serializing_if="Option::is_none")]
  authentication_oauth_client_scope: Option<String>,
  ...
  #[serde(rename = "authenticationOauthClientSecret", skip_serializing_if="Option::is_none")]
  authentication_oauth_client_secret: Option<String>,
  ...
  #[serde(rename = "authenticationOauthClientTokenEndpoint", skip_serializing_if="Option::is_none")]
  authentication_oauth_client_token_endpoint: Option<String>,
  ...
  enabled: Option<bool>,
  /// The HTTP method to use (POST or PUT). This is used only when operating in the REST service \"messaging\" mode and is ignored in \"gateway\" mode. The default value is `\"post\"`. The allowed values and their meaning are:  <pre> \"post\" - Use the POST HTTP method. \"put\" - Use the PUT HTTP method. </pre>  Available since 2.17.
...
impl MsgVpnRestDeliveryPointRestConsumer {
  pub fn new() -> MsgVpnRestDeliveryPointRestConsumer {
    MsgVpnRestDeliveryPointRestConsumer {
      ...
      authentication_http_header_name: None,
      authentication_http_header_value: None,
      authentication_oauth_client_id: None,
      authentication_oauth_client_scope: None,
      authentication_oauth_client_secret: None,
      authentication_oauth_client_token_endpoint: None,
  ...
  pub fn set_authentication_http_header_name(&mut self, authentication_http_header_name: String) {
    self.authentication_http_header_name = Some(authentication_http_header_name);
  }

  pub fn with_authentication_http_header_name(mut self, authentication_http_header_name: String) -> MsgVpnRestDeliveryPointRestConsumer {
    self.authentication_http_header_name = Some(authentication_http_header_name);
    self
  }

  pub fn authentication_http_header_name(&self) -> Option<&String> {
    self.authentication_http_header_name.as_ref()
  }

  pub fn reset_authentication_http_header_name(&mut self) {
    self.authentication_http_header_name = None;
  }

  pub fn set_authentication_http_header_value(&mut self, authentication_http_header_value: String) {
    self.authentication_http_header_value = Some(authentication_http_header_value);
  }

  pub fn with_authentication_http_header_value(mut self, authentication_http_header_value: String) -> MsgVpnRestDeliveryPointRestConsumer {
    self.authentication_http_header_value = Some(authentication_http_header_value);
    self
  }

  pub fn authentication_http_header_value(&self) -> Option<&String> {
    self.authentication_http_header_value.as_ref()
  }

  pub fn reset_authentication_http_header_value(&mut self) {
    self.authentication_http_header_value = None;
  }

  pub fn set_authentication_oauth_client_id(&mut self, authentication_oauth_client_id: String) {
    self.authentication_oauth_client_id = Some(authentication_oauth_client_id);
  }

  pub fn with_authentication_oauth_client_id(mut self, authentication_oauth_client_id: String) -> MsgVpnRestDeliveryPointRestConsumer {
    self.authentication_oauth_client_id = Some(authentication_oauth_client_id);
    self
  }

  pub fn authentication_oauth_client_id(&self) -> Option<&String> {
    self.authentication_oauth_client_id.as_ref()
  }

  pub fn reset_authentication_oauth_client_id(&mut self) {
    self.authentication_oauth_client_id = None;
  }

  pub fn set_authentication_oauth_client_scope(&mut self, authentication_oauth_client_scope: String) {
    self.authentication_oauth_client_scope = Some(authentication_oauth_client_scope);
  }

  pub fn with_authentication_oauth_client_scope(mut self, authentication_oauth_client_scope: String) -> MsgVpnRestDeliveryPointRestConsumer {
    self.authentication_oauth_client_scope = Some(authentication_oauth_client_scope);
    self
  }

  pub fn authentication_oauth_client_scope(&self) -> Option<&String> {
    self.authentication_oauth_client_scope.as_ref()
  }

  pub fn reset_authentication_oauth_client_scope(&mut self) {
    self.authentication_oauth_client_scope = None;
  }

  pub fn set_authentication_oauth_client_secret(&mut self, authentication_oauth_client_secret: String) {
    self.authentication_oauth_client_secret = Some(authentication_oauth_client_secret);
  }

  pub fn with_authentication_oauth_client_secret(mut self, authentication_oauth_client_secret: String) -> MsgVpnRestDeliveryPointRestConsumer {
    self.authentication_oauth_client_secret = Some(authentication_oauth_client_secret);
    self
  }

  pub fn authentication_oauth_client_secret(&self) -> Option<&String> {
    self.authentication_oauth_client_secret.as_ref()
  }

  pub fn reset_authentication_oauth_client_secret(&mut self) {
    self.authentication_oauth_client_secret = None;
  }

  pub fn set_authentication_oauth_client_token_endpoint(&mut self, authentication_oauth_client_token_endpoint: String) {
    self.authentication_oauth_client_token_endpoint = Some(authentication_oauth_client_token_endpoint);
  }

  pub fn with_authentication_oauth_client_token_endpoint(mut self, authentication_oauth_client_token_endpoint: String) -> MsgVpnRestDeliveryPointRestConsumer {
    self.authentication_oauth_client_token_endpoint = Some(authentication_oauth_client_token_endpoint);
    self
  }

  pub fn authentication_oauth_client_token_endpoint(&self) -> Option<&String> {
    self.authentication_oauth_client_token_endpoint.as_ref()
  }

  pub fn reset_authentication_oauth_client_token_endpoint(&mut self) {
    self.authentication_oauth_client_token_endpoint = None;
  }
  ...
  pub fn set_http_method(&mut self, http_method: String) {
    self.http_method = Some(http_method);
  }

  pub fn with_http_method(mut self, http_method: String) -> MsgVpnRestDeliveryPointRestConsumer {
    self.http_method = Some(http_method);
    self
  }
  ...
  pub fn reset_http_method(&mut self) {
