...
pub struct MsgVpnAclProfile {
  ...
  /// The default action to take when a Client connects. The default value is `\"disallow\"`. The allowed values and their meaning are:  <pre> \"allow\" - Allow client connection unless an exception is found for it. \"disallow\" - Disallow client connection unless an exception is found for it. </pre> 
  #[serde(rename = "clientConnectDefaultAction")]
  client_connect_default_action: Option<String>,
  /// The name of the Message VPN.
  #[serde(rename = "msgVpnName")]
  msg_vpn_name: Option<String>,
  /// The default action to take when a Client publishes to a Topic. The default value is `\"disallow\"`. The allowed values and their meaning are:  <pre> \"allow\" - Allow topic unless an exception is found for it. \"disallow\" - Disallow topic unless an exception is found for it. </pre> 
  #[serde(rename = "publishTopicDefaultAction")]
  ...
  #[serde(rename = "subscribeTopicDefaultAction")]
