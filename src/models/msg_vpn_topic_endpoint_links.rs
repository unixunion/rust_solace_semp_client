...
pub struct MsgVpnTopicEndpointLinks {
  /// The URI of this MsgVpnTopicEndpoint object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnTopicEndpointLinks {
  pub fn new() -> MsgVpnTopicEndpointLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnTopicEndpointLinks {
    self.uri = Some(uri);
    self
  }
