...
pub struct AboutUserResponse {
  ...
  data: Option<::models::AboutUser>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::AboutUserLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl AboutUserResponse {
  pub fn new(meta: ::models::SempMeta) -> AboutUserResponse {
    AboutUserResponse {
      data: None,
      links: None,
      meta: meta
  ...
  pub fn set_data(&mut self, data: ::models::AboutUser) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::AboutUser) -> AboutUserResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::AboutUser> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::AboutUserLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::AboutUserLinks) -> AboutUserResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::AboutUserLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> AboutUserResponse {
    self.meta = meta;
    self
  }
