...
pub struct DmrClustersResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<Vec<::models::DmrCluster>>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<Vec<::models::DmrClusterLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl DmrClustersResponse {
  pub fn new(meta: ::models::SempMeta) -> DmrClustersResponse {
    DmrClustersResponse {
      data: None,
      links: None,
      meta: meta
  ...
  pub fn set_data(&mut self, data: Vec<::models::DmrCluster>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::DmrCluster>) -> DmrClustersResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::DmrCluster>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::DmrClusterLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::DmrClusterLinks>) -> DmrClustersResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::DmrClusterLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> DmrClustersResponse {
    self.meta = meta;
    self
  }
