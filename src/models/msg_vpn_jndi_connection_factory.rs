...
pub struct MsgVpnJndiConnectionFactory {
  ...
  #[serde(rename = "guaranteedReceiveReconnectRetryCount", skip_serializing_if="Option::is_none")]
  guaranteed_receive_reconnect_retry_count: Option<i32>,
  ...
  #[serde(rename = "guaranteedReceiveReconnectRetryWait", skip_serializing_if="Option::is_none")]
  guaranteed_receive_reconnect_retry_wait: Option<i32>,
...
impl MsgVpnJndiConnectionFactory {
  pub fn new() -> MsgVpnJndiConnectionFactory {
    MsgVpnJndiConnectionFactory {
      ...
      guaranteed_receive_reconnect_retry_count: None,
      guaranteed_receive_reconnect_retry_wait: None,
  ...
  pub fn set_guaranteed_receive_reconnect_retry_count(&mut self, guaranteed_receive_reconnect_retry_count: i32) {
    self.guaranteed_receive_reconnect_retry_count = Some(guaranteed_receive_reconnect_retry_count);
  }

  pub fn with_guaranteed_receive_reconnect_retry_count(mut self, guaranteed_receive_reconnect_retry_count: i32) -> MsgVpnJndiConnectionFactory {
    self.guaranteed_receive_reconnect_retry_count = Some(guaranteed_receive_reconnect_retry_count);
    self
  }

  pub fn guaranteed_receive_reconnect_retry_count(&self) -> Option<&i32> {
    self.guaranteed_receive_reconnect_retry_count.as_ref()
  }

  pub fn reset_guaranteed_receive_reconnect_retry_count(&mut self) {
    self.guaranteed_receive_reconnect_retry_count = None;
  }

  pub fn set_guaranteed_receive_reconnect_retry_wait(&mut self, guaranteed_receive_reconnect_retry_wait: i32) {
    self.guaranteed_receive_reconnect_retry_wait = Some(guaranteed_receive_reconnect_retry_wait);
  }

  pub fn with_guaranteed_receive_reconnect_retry_wait(mut self, guaranteed_receive_reconnect_retry_wait: i32) -> MsgVpnJndiConnectionFactory {
    self.guaranteed_receive_reconnect_retry_wait = Some(guaranteed_receive_reconnect_retry_wait);
    self
  }

  pub fn guaranteed_receive_reconnect_retry_wait(&self) -> Option<&i32> {
    self.guaranteed_receive_reconnect_retry_wait.as_ref()
  }

  pub fn reset_guaranteed_receive_reconnect_retry_wait(&mut self) {
    self.guaranteed_receive_reconnect_retry_wait = None;
  }
