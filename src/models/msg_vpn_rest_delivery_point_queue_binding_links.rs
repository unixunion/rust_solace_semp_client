...
pub struct MsgVpnRestDeliveryPointQueueBindingLinks {
  /// The URI of this MsgVpnRestDeliveryPointQueueBinding object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnRestDeliveryPointQueueBindingLinks {
  pub fn new() -> MsgVpnRestDeliveryPointQueueBindingLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnRestDeliveryPointQueueBindingLinks {
    self.uri = Some(uri);
    self
  }
