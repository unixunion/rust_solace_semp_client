...
pub struct MsgVpnClientProfile {
  ...
  /// Enable or disable allowing shared subscriptions. The default value is `false`. Available since 2.11.
  ...
  /// The maximum number of transmit flows per client using the Client Profile. The default is the max value supported by the platform.
  #[serde(rename = "maxEgressFlowCount", skip_serializing_if="Option::is_none")]
  max_egress_flow_count: Option<i64>,
  /// The maximum number of queues and topic endpoints per Client Username using the Client Profile. The default is the max value supported by the platform.
  ...
  /// The maximum number of receive flows per client using the Client Profile. The default is the max value supported by the platform.
  ...
  /// The maximum number of transacted sessions per client using the Client Profile. The default value is `10`.
  #[serde(rename = "maxTransactedSessionCount", skip_serializing_if="Option::is_none")]
  max_transacted_session_count: Option<i64>,
  /// The maximum number of transactions per client using the Client Profile. The default varies by platform.
