...
pub struct MsgVpnAclProfilePublishExceptionLinks {
  /// The URI of this MsgVpnAclProfilePublishException object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnAclProfilePublishExceptionLinks {
  pub fn new() -> MsgVpnAclProfilePublishExceptionLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnAclProfilePublishExceptionLinks {
    self.uri = Some(uri);
    self
  }
