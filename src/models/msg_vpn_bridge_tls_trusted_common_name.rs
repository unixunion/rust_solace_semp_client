...
impl MsgVpnBridgeTlsTrustedCommonName {
  pub fn new() -> MsgVpnBridgeTlsTrustedCommonName {
    MsgVpnBridgeTlsTrustedCommonName {
      bridge_name: None,
      bridge_virtual_router: None,
      msg_vpn_name: None,
      tls_trusted_common_name: None
    }
  }
  ...
  pub fn with_bridge_name(mut self, bridge_name: String) -> MsgVpnBridgeTlsTrustedCommonName {
    self.bridge_name = Some(bridge_name);
    self
  }
  ...
  pub fn with_bridge_virtual_router(mut self, bridge_virtual_router: String) -> MsgVpnBridgeTlsTrustedCommonName {
    self.bridge_virtual_router = Some(bridge_virtual_router);
    self
  }
  ...
  pub fn with_msg_vpn_name(mut self, msg_vpn_name: String) -> MsgVpnBridgeTlsTrustedCommonName {
    self.msg_vpn_name = Some(msg_vpn_name);
    self
  }
  ...
  pub fn set_tls_trusted_common_name(&mut self, tls_trusted_common_name: String) {
    self.tls_trusted_common_name = Some(tls_trusted_common_name);
  }

  pub fn with_tls_trusted_common_name(mut self, tls_trusted_common_name: String) -> MsgVpnBridgeTlsTrustedCommonName {
    self.tls_trusted_common_name = Some(tls_trusted_common_name);
    self
  }

  pub fn tls_trusted_common_name(&self) -> Option<&String> {
    self.tls_trusted_common_name.as_ref()
  }

  pub fn reset_tls_trusted_common_name(&mut self) {
    self.tls_trusted_common_name = None;
  }
