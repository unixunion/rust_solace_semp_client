...
impl SempPaging {
  pub fn new(cursor_query: String, next_page_uri: String) -> SempPaging {
    SempPaging {
  ...
  pub fn set_cursor_query(&mut self, cursor_query: String) {
    self.cursor_query = cursor_query;
  }

  pub fn with_cursor_query(mut self, cursor_query: String) -> SempPaging {
    self.cursor_query = cursor_query;
    self
  }

  pub fn cursor_query(&self) -> &String {
    &self.cursor_query
  }


  pub fn set_next_page_uri(&mut self, next_page_uri: String) {
    self.next_page_uri = next_page_uri;
  }

  pub fn with_next_page_uri(mut self, next_page_uri: String) -> SempPaging {
    self.next_page_uri = next_page_uri;
    self
  }

  pub fn next_page_uri(&self) -> &String {
    &self.next_page_uri
  }
