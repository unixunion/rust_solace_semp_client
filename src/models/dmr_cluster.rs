...
pub struct DmrCluster {
  ...
  #[serde(rename = "tlsServerCertValidateNameEnabled", skip_serializing_if="Option::is_none")]
  tls_server_cert_validate_name_enabled: Option<bool>
}
...
impl DmrCluster {
  pub fn new() -> DmrCluster {
    DmrCluster {
      ...
      tls_server_cert_validate_name_enabled: None
    }
  }
  ...
  pub fn with_authentication_basic_password(mut self, authentication_basic_password: String) -> DmrCluster {
    self.authentication_basic_password = Some(authentication_basic_password);
    self
  }
  ...
  pub fn with_authentication_client_cert_content(mut self, authentication_client_cert_content: String) -> DmrCluster {
    self.authentication_client_cert_content = Some(authentication_client_cert_content);
    self
  }
  ...
  pub fn with_authentication_client_cert_password(mut self, authentication_client_cert_password: String) -> DmrCluster {
    self.authentication_client_cert_password = Some(authentication_client_cert_password);
    self
  }
  ...
  pub fn set_tls_server_cert_validate_name_enabled(&mut self, tls_server_cert_validate_name_enabled: bool) {
    self.tls_server_cert_validate_name_enabled = Some(tls_server_cert_validate_name_enabled);
  }

  pub fn with_tls_server_cert_validate_name_enabled(mut self, tls_server_cert_validate_name_enabled: bool) -> DmrCluster {
    self.tls_server_cert_validate_name_enabled = Some(tls_server_cert_validate_name_enabled);
    self
  }

  pub fn tls_server_cert_validate_name_enabled(&self) -> Option<&bool> {
    self.tls_server_cert_validate_name_enabled.as_ref()
  }

  pub fn reset_tls_server_cert_validate_name_enabled(&mut self) {
    self.tls_server_cert_validate_name_enabled = None;
  }
