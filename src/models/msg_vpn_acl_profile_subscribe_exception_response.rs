...
pub struct MsgVpnAclProfileSubscribeExceptionResponse {
      #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnAclProfileSubscribeException>,
      #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnAclProfileSubscribeExceptionLinks>,
      #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnAclProfileSubscribeExceptionResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnAclProfileSubscribeExceptionResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnAclProfileSubscribeException) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnAclProfileSubscribeException) -> MsgVpnAclProfileSubscribeExceptionResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnAclProfileSubscribeException> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnAclProfileSubscribeExceptionLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnAclProfileSubscribeExceptionLinks) -> MsgVpnAclProfileSubscribeExceptionResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnAclProfileSubscribeExceptionLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnAclProfileSubscribeExceptionResponse {
    self.meta = meta;
    self
  }
