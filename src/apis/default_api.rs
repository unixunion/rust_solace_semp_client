...
pub trait DefaultApi {
    ...
    fn create_dmr_cluster_link_tls_trusted_common_name(&self, dmr_cluster_name: &str, remote_node_name: &str, body: ::models::DmrClusterLinkTlsTrustedCommonName, select: Vec<String>) -> Box<Future<Item = ::models::DmrClusterLinkTlsTrustedCommonNameResponse, Error = Error<serde_json::Value>>>;
    ...
    fn create_msg_vpn_distributed_cache(&self, msg_vpn_name: &str, body: ::models::MsgVpnDistributedCache, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheResponse, Error = Error<serde_json::Value>>>;
    fn create_msg_vpn_distributed_cache_cluster(&self, msg_vpn_name: &str, cache_name: &str, body: ::models::MsgVpnDistributedCacheCluster, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterResponse, Error = Error<serde_json::Value>>>;
    fn create_msg_vpn_distributed_cache_cluster_global_caching_home_cluster(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, body: ::models::MsgVpnDistributedCacheClusterGlobalCachingHomeCluster, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterGlobalCachingHomeClusterResponse, Error = Error<serde_json::Value>>>;
    fn create_msg_vpn_distributed_cache_cluster_global_caching_home_cluster_topic_prefix(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, home_cluster_name: &str, body: ::models::MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefix, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterGlobalCachingHomeClusterTopicPrefixResponse, Error = Error<serde_json::Value>>>;
    fn create_msg_vpn_distributed_cache_cluster_instance(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstance, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterInstanceResponse, Error = Error<serde_json::Value>>>;
    fn create_msg_vpn_distributed_cache_cluster_topic(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, body: ::models::MsgVpnDistributedCacheClusterTopic, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterTopicResponse, Error = Error<serde_json::Value>>>;
    fn create_msg_vpn_dmr_bridge(&self, msg_vpn_name: &str, body: ::models::MsgVpnDmrBridge, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDmrBridgeResponse, Error = Error<serde_json::Value>>>;
    ...
    fn create_msg_vpn_mqtt_retain_cache(&self, msg_vpn_name: &str, body: ::models::MsgVpnMqttRetainCache, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnMqttRetainCacheResponse, Error = Error<serde_json::Value>>>;
    ...
    fn delete_dmr_cluster_link_tls_trusted_common_name(&self, dmr_cluster_name: &str, remote_node_name: &str, tls_trusted_common_name: &str) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    ...
    fn replace_msg_vpn_distributed_cache(&self, msg_vpn_name: &str, cache_name: &str, body: ::models::MsgVpnDistributedCache, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheResponse, Error = Error<serde_json::Value>>>;
    fn replace_msg_vpn_distributed_cache_cluster(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, body: ::models::MsgVpnDistributedCacheCluster, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterResponse, Error = Error<serde_json::Value>>>;
    fn replace_msg_vpn_distributed_cache_cluster_instance(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstance, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterInstanceResponse, Error = Error<serde_json::Value>>>;
    fn replace_msg_vpn_dmr_bridge(&self, msg_vpn_name: &str, remote_node_name: &str, body: ::models::MsgVpnDmrBridge, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDmrBridgeResponse, Error = Error<serde_json::Value>>>;
    ...
    fn replace_msg_vpn_mqtt_retain_cache(&self, msg_vpn_name: &str, cache_name: &str, body: ::models::MsgVpnMqttRetainCache, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnMqttRetainCacheResponse, Error = Error<serde_json::Value>>>;
    ...
    fn update_msg_vpn_distributed_cache(&self, msg_vpn_name: &str, cache_name: &str, body: ::models::MsgVpnDistributedCache, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheResponse, Error = Error<serde_json::Value>>>;
    fn update_msg_vpn_distributed_cache_cluster(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, body: ::models::MsgVpnDistributedCacheCluster, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterResponse, Error = Error<serde_json::Value>>>;
    fn update_msg_vpn_distributed_cache_cluster_instance(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstance, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDistributedCacheClusterInstanceResponse, Error = Error<serde_json::Value>>>;
    fn update_msg_vpn_dmr_bridge(&self, msg_vpn_name: &str, remote_node_name: &str, body: ::models::MsgVpnDmrBridge, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnDmrBridgeResponse, Error = Error<serde_json::Value>>>;
    ...
    fn update_msg_vpn_mqtt_retain_cache(&self, msg_vpn_name: &str, cache_name: &str, body: ::models::MsgVpnMqttRetainCache, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnMqttRetainCacheResponse, Error = Error<serde_json::Value>>>;
