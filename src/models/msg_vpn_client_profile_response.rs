...
impl MsgVpnClientProfileResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnClientProfileResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnClientProfile) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnClientProfile) -> MsgVpnClientProfileResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnClientProfile> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnClientProfileLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnClientProfileLinks) -> MsgVpnClientProfileResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnClientProfileLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnClientProfileResponse {
    self.meta = meta;
    self
  }
