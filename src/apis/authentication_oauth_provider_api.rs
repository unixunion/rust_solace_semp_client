...
pub struct AuthenticationOauthProviderApiClient<C: hyper::client::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::Connect> AuthenticationOauthProviderApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> AuthenticationOauthProviderApiClient<C> {
        AuthenticationOauthProviderApiClient {
            configuration: configuration,
        }
    }
}

pub trait AuthenticationOauthProviderApi {
...
impl<C: hyper::client::Connect>AuthenticationOauthProviderApi for AuthenticationOauthProviderApiClient<C> {
    fn create_msg_vpn_authentication_oauth_provider(&self, msg_vpn_name: &str, body: ::models::MsgVpnAuthenticationOauthProvider, opaque_password: &str, select: Vec<String>) -> Box<Future<Item = ::models::MsgVpnAuthenticationOauthProviderResponse, Error = Error<serde_json::Value>>> {
