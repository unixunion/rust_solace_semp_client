...
pub struct MsgVpnQueueSubscriptionLinks {
  /// The URI of this MsgVpnQueueSubscription object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnQueueSubscriptionLinks {
  pub fn new() -> MsgVpnQueueSubscriptionLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnQueueSubscriptionLinks {
    self.uri = Some(uri);
    self
  }
