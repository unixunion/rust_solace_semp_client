...
pub struct MsgVpnMqttSessionSubscriptionLinks {
  /// The URI of this MsgVpnMqttSessionSubscription object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnMqttSessionSubscriptionLinks {
  pub fn new() -> MsgVpnMqttSessionSubscriptionLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnMqttSessionSubscriptionLinks {
    self.uri = Some(uri);
    self
  }
