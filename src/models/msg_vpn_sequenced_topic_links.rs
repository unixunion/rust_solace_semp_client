...
pub struct MsgVpnSequencedTopicLinks {
  /// The URI of this MsgVpnSequencedTopic object.
  #[serde(rename = "uri")]
  uri: Option<String>
}

impl MsgVpnSequencedTopicLinks {
  pub fn new() -> MsgVpnSequencedTopicLinks {
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnSequencedTopicLinks {
    self.uri = Some(uri);
    self
  }
