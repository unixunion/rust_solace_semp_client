...
pub struct CertAuthority {
  ...
  /// The PEM formatted content for the trusted root certificate of a Certificate Authority. The default value is `\"\"`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.
  #[serde(rename = "certContent", skip_serializing_if="Option::is_none")]
  ...
  /// The scheduled CRL refresh time(s), specified as \"hourly\" or a comma-separated list of 24-hour times in the form hh:mm, or h:mm. There must be no spaces, and times must be in sorted order from 0:00 to 23:59. The default value is `\"3:00\"`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.
  #[serde(rename = "crlTimeList", skip_serializing_if="Option::is_none")]
  crl_time_list: Option<String>,
  /// The URL for the CRL source. This is a required attribute for CRL to be operational and the URL must be complete with http:// included. The default value is `\"\"`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.
  ...
  /// The OCSP responder URL to use for overriding the one supplied in the client certificate. The URL must be complete with http:// included. The default value is `\"\"`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.
  #[serde(rename = "ocspOverrideUrl", skip_serializing_if="Option::is_none")]
  ocsp_override_url: Option<String>,
  /// The timeout in seconds to receive a response from the OCSP responder after sending a request or making the initial connection attempt. The default value is `5`. Deprecated since 2.19. certAuthorities replaced by clientCertAuthorities and domainCertAuthorities.
...
impl CertAuthority {
  ...
  pub fn set_cert_content(&mut self, cert_content: String) {
    self.cert_content = Some(cert_content);
  }

  pub fn with_cert_content(mut self, cert_content: String) -> CertAuthority {
    self.cert_content = Some(cert_content);
    self
  }

  pub fn cert_content(&self) -> Option<&String> {
    self.cert_content.as_ref()
  }

  pub fn reset_cert_content(&mut self) {
