...
impl MsgVpnBridgeLinks {
  pub fn new() -> MsgVpnBridgeLinks {
    MsgVpnBridgeLinks {
      remote_msg_vpns_uri: None,
      remote_subscriptions_uri: None,
      tls_trusted_common_names_uri: None,
      uri: None
    }
  }

  pub fn set_remote_msg_vpns_uri(&mut self, remote_msg_vpns_uri: String) {
    self.remote_msg_vpns_uri = Some(remote_msg_vpns_uri);
  }

  pub fn with_remote_msg_vpns_uri(mut self, remote_msg_vpns_uri: String) -> MsgVpnBridgeLinks {
    self.remote_msg_vpns_uri = Some(remote_msg_vpns_uri);
    self
  }

  pub fn remote_msg_vpns_uri(&self) -> Option<&String> {
    self.remote_msg_vpns_uri.as_ref()
  }

  pub fn reset_remote_msg_vpns_uri(&mut self) {
    self.remote_msg_vpns_uri = None;
  }

  pub fn set_remote_subscriptions_uri(&mut self, remote_subscriptions_uri: String) {
    self.remote_subscriptions_uri = Some(remote_subscriptions_uri);
  }

  pub fn with_remote_subscriptions_uri(mut self, remote_subscriptions_uri: String) -> MsgVpnBridgeLinks {
    self.remote_subscriptions_uri = Some(remote_subscriptions_uri);
    self
  }

  pub fn remote_subscriptions_uri(&self) -> Option<&String> {
    self.remote_subscriptions_uri.as_ref()
  }

  pub fn reset_remote_subscriptions_uri(&mut self) {
    self.remote_subscriptions_uri = None;
  }

  pub fn set_tls_trusted_common_names_uri(&mut self, tls_trusted_common_names_uri: String) {
    self.tls_trusted_common_names_uri = Some(tls_trusted_common_names_uri);
  }

  pub fn with_tls_trusted_common_names_uri(mut self, tls_trusted_common_names_uri: String) -> MsgVpnBridgeLinks {
    self.tls_trusted_common_names_uri = Some(tls_trusted_common_names_uri);
    self
  }

  pub fn tls_trusted_common_names_uri(&self) -> Option<&String> {
    self.tls_trusted_common_names_uri.as_ref()
  }

  pub fn reset_tls_trusted_common_names_uri(&mut self) {
    self.tls_trusted_common_names_uri = None;
  }
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnBridgeLinks {
    self.uri = Some(uri);
    self
  }
