...
pub struct MsgVpnClientProfile {
  /// Allow or deny Bridge connections. The default value is `false`.
  #[serde(rename = "allowBridgeConnectionsEnabled")]
  allow_bridge_connections_enabled: Option<bool>,
  /// Allow or deny clients to use the cut-through delivery mode. Changing this value does not affect existing client connections. The default value is `false`.
  #[serde(rename = "allowCutThroughForwardingEnabled")]
  allow_cut_through_forwarding_enabled: Option<bool>,
  /// Allow or deny clients to create topic endponts or queues. Changing this value does not affect existing client connections. The default value is `false`.
  #[serde(rename = "allowGuaranteedEndpointCreateEnabled")]
  allow_guaranteed_endpoint_create_enabled: Option<bool>,
  /// Allow or deny clients to receive guaranteed messages. Changing this value does not affect existing client connections. The default value is `false`.
  #[serde(rename = "allowGuaranteedMsgReceiveEnabled")]
  allow_guaranteed_msg_receive_enabled: Option<bool>,
  /// Allow or deny clients to send guaranteed messages. Changing this value does not affect existing client connections. The default value is `false`.
  #[serde(rename = "allowGuaranteedMsgSendEnabled")]
  allow_guaranteed_msg_send_enabled: Option<bool>,
  /// Allow or deny clients to establish transacted sessions. Changing this value does not affect existing client connections. The default value is `false`.
  ...
  /// The maximum number of topics for Message Eliding per one Client connection. The default value is `256`.
  ...
  /// The maximum number of outgoing (egress) flows that can be created by one client. The default is the max value supported by the hardware.
  ...
  /// The maximum number of incoming (ingress) flows that can be created by one client. The default is the max value supported by the hardware.
  ...
  /// Allow to deny clients connection to the Message VPN if its Replication is in the standby state. The default value is `false`.
  ...
  /// The TCP initial congestion window size, in multiple of the TCP Maximum Segment Size (MSS). Changing the value from its default of 2 results in non-compliance with RFC 2581. Contact Solace Support before changing the value. The default value is `2`.
  #[serde(rename = "tcpCongestionWindowSize")]
  tcp_congestion_window_size: Option<i64>,
  /// The number of the TCP keepalive packet retransmissions to be carried out before declaring that remote end is not available. The default value is `5`.
  #[serde(rename = "tcpKeepaliveCount")]
  tcp_keepalive_count: Option<i64>,
  /// The duration between two TCP keepalive transmissions in idle condition, in seconds. The default value is `3`.
  #[serde(rename = "tcpKeepaliveIdleTime")]
  tcp_keepalive_idle_time: Option<i64>,
  /// The duration between two successive TCP keepalive retransmissions, if acknowledgement to the previous TCP keepalive transmission is not received, in seconds. The default value is `1`.
  #[serde(rename = "tcpKeepaliveInterval")]
  tcp_keepalive_interval: Option<i64>,
  /// The the largest amount of data to receive in a single TCP segment, in kilobytes. The default value is `1460`.
