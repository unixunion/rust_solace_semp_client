...
pub struct MsgVpnQueueSubscriptionResponse {
  #[serde(rename = "data")]
  data: Option<::models::MsgVpnQueueSubscription>,
  #[serde(rename = "links")]
  links: Option<::models::MsgVpnQueueSubscriptionLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnQueueSubscriptionResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnQueueSubscriptionResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnQueueSubscription) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnQueueSubscription) -> MsgVpnQueueSubscriptionResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnQueueSubscription> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnQueueSubscriptionLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnQueueSubscriptionLinks) -> MsgVpnQueueSubscriptionResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnQueueSubscriptionLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnQueueSubscriptionResponse {
    self.meta = meta;
    self
  }
