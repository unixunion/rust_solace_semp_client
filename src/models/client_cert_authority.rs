...
pub struct ClientCertAuthority {
...
impl ClientCertAuthority {
  pub fn new() -> ClientCertAuthority {
    ClientCertAuthority {
  ...
  pub fn with_cert_authority_name(mut self, cert_authority_name: String) -> ClientCertAuthority {
    self.cert_authority_name = Some(cert_authority_name);
    self
  }
  ...
  pub fn with_cert_content(mut self, cert_content: String) -> ClientCertAuthority {
    self.cert_content = Some(cert_content);
    self
  }
  ...
  pub fn with_crl_day_list(mut self, crl_day_list: String) -> ClientCertAuthority {
    self.crl_day_list = Some(crl_day_list);
    self
  }
  ...
  pub fn with_crl_time_list(mut self, crl_time_list: String) -> ClientCertAuthority {
    self.crl_time_list = Some(crl_time_list);
    self
  }
  ...
  pub fn with_crl_url(mut self, crl_url: String) -> ClientCertAuthority {
    self.crl_url = Some(crl_url);
    self
  }
  ...
  pub fn with_ocsp_non_responder_cert_enabled(mut self, ocsp_non_responder_cert_enabled: bool) -> ClientCertAuthority {
    self.ocsp_non_responder_cert_enabled = Some(ocsp_non_responder_cert_enabled);
    self
  }
  ...
  pub fn with_ocsp_override_url(mut self, ocsp_override_url: String) -> ClientCertAuthority {
    self.ocsp_override_url = Some(ocsp_override_url);
    self
  }
  ...
  pub fn with_ocsp_timeout(mut self, ocsp_timeout: i64) -> ClientCertAuthority {
    self.ocsp_timeout = Some(ocsp_timeout);
    self
  }
  ...
  pub fn with_revocation_check_enabled(mut self, revocation_check_enabled: bool) -> ClientCertAuthority {
    self.revocation_check_enabled = Some(revocation_check_enabled);
    self
  }
