...
pub struct MsgVpnDmrBridgeResponse {
  #[serde(rename = "data", skip_serializing_if="Option::is_none")]
  data: Option<::models::MsgVpnDmrBridge>,
  #[serde(rename = "links", skip_serializing_if="Option::is_none")]
  links: Option<::models::MsgVpnDmrBridgeLinks>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnDmrBridgeResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnDmrBridgeResponse {
  ...
  pub fn set_data(&mut self, data: ::models::MsgVpnDmrBridge) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: ::models::MsgVpnDmrBridge) -> MsgVpnDmrBridgeResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&::models::MsgVpnDmrBridge> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: ::models::MsgVpnDmrBridgeLinks) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: ::models::MsgVpnDmrBridgeLinks) -> MsgVpnDmrBridgeResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&::models::MsgVpnDmrBridgeLinks> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnDmrBridgeResponse {
    self.meta = meta;
    self
  }
