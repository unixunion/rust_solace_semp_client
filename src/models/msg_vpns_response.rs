...
pub struct MsgVpnsResponse {
  #[serde(rename = "data")]
  data: Option<Vec<::models::MsgVpn>>,
  #[serde(rename = "links")]
  links: Option<Vec<::models::MsgVpnLinks>>,
  #[serde(rename = "meta")]
  meta: ::models::SempMeta
}

impl MsgVpnsResponse {
  pub fn new(meta: ::models::SempMeta) -> MsgVpnsResponse {
    MsgVpnsResponse {
      data: None,
      links: None,
      meta: meta
  ...
  pub fn set_data(&mut self, data: Vec<::models::MsgVpn>) {
    self.data = Some(data);
  }

  pub fn with_data(mut self, data: Vec<::models::MsgVpn>) -> MsgVpnsResponse {
    self.data = Some(data);
    self
  }

  pub fn data(&self) -> Option<&Vec<::models::MsgVpn>> {
    self.data.as_ref()
  }
  ...
  pub fn set_links(&mut self, links: Vec<::models::MsgVpnLinks>) {
    self.links = Some(links);
  }

  pub fn with_links(mut self, links: Vec<::models::MsgVpnLinks>) -> MsgVpnsResponse {
    self.links = Some(links);
    self
  }

  pub fn links(&self) -> Option<&Vec<::models::MsgVpnLinks>> {
    self.links.as_ref()
  }
  ...
  pub fn with_meta(mut self, meta: ::models::SempMeta) -> MsgVpnsResponse {
    self.meta = meta;
    self
  }
